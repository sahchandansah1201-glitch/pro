  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Risk tokens — всегда сопровождаются текстовой меткой через <RiskBadge />.
        risk: {
