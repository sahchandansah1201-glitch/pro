...
test("meta and openapi routes expose contracts without runtime secrets", async () => {
  ...
  assert.equal(openapi4h.json.info.version, "4L-Q4-body-atlas-geometry");
...
function clinicalWorkspaceRuntime({
  ...
  lesionLongitudinalQa = null,
  lesionCaptureMetadata = null,
  ...
  visitLongitudinalTimelineRollout = null,
  ...
  visitLongitudinalTimelineRolloutExceptionGovernance = null,
  visitLongitudinalTimelineRolloutOutcomeGovernance = null,
  visitLongitudinalTimelineRolloutLongitudinalClinicalValidation = null,
  visitLongitudinalTimelineRolloutProtectedReviewerGovernance = null,
  ...
  return {
    ...
    clinicalWorkspaceService: {
      ...
      async getLesionLongitudinalQa() {
        if (clinicalError) throw clinicalError;
        return { qa: lesionLongitudinalQa, scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] } };
      },
      async getLesionCaptureMetadata() {
        if (clinicalError) throw clinicalError;
        return { metadata: lesionCaptureMetadata, scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] } };
      },
      async saveAssetCaptureMetadata() {
        if (clinicalError) throw clinicalError;
        return { metadata: assetCaptureMetadata, scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] } };
      },
      async saveLesionComparisonViewerQa() {
        if (clinicalError) throw clinicalError;
        return { qa: lesionComparisonViewerQa, scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] } };
      },
      ...
      async reviewVisitLongitudinalTimelineRollout() {
        if (clinicalError) throw clinicalError;
        return {
          rollout: visitLongitudinalTimelineRollout,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutSop() {
        if (clinicalError) throw clinicalError;
        return {
          sop: visitLongitudinalTimelineRolloutSop,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutEvidence() {
        if (clinicalError) throw clinicalError;
        return {
          evidence: visitLongitudinalTimelineRolloutEvidence,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutMonitoring() {
        if (clinicalError) throw clinicalError;
        return {
      ...
      async reviewVisitLongitudinalTimelineRolloutClinicalValidation() {
        if (clinicalError) throw clinicalError;
        return {
          clinicalValidation: visitLongitudinalTimelineRolloutClinicalValidation,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      ...
      async reviewVisitLongitudinalTimelineRolloutExceptionGovernance() {
        if (clinicalError) throw clinicalError;
        return {
          exceptionGovernance: visitLongitudinalTimelineRolloutExceptionGovernance,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutOutcomeGovernance() {
        if (clinicalError) throw clinicalError;
        return {
          outcomeGovernance: visitLongitudinalTimelineRolloutOutcomeGovernance,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutLongitudinalClinicalValidation() {
        if (clinicalError) throw clinicalError;
        return {
          longitudinalClinicalValidation: visitLongitudinalTimelineRolloutLongitudinalClinicalValidation,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutProtectedReviewerValidation() {
        if (clinicalError) throw clinicalError;
        return {
          protectedReviewerValidation: visitLongitudinalTimelineRolloutProtectedReviewerValidation,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutProtectedReviewerGovernance() {
        if (clinicalError) throw clinicalError;
        return {
          protectedReviewerGovernance: visitLongitudinalTimelineRolloutProtectedReviewerGovernance,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
      async reviewVisitLongitudinalTimelineRolloutProtectedReviewerEvidence() {
        if (clinicalError) throw clinicalError;
        return {
          protectedReviewerEvidence: visitLongitudinalTimelineRolloutProtectedReviewerEvidence,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
        };
      },
    ...
    patientPhotoProtocolReleaseService: {
      ...
      async executeGovernanceBlockUnapprovedRetention() {
        if (clinicalError) throw clinicalError;
        return {
          operation: photoProtocolReleaseGovernanceOperation,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
      ...
      async executeGovernanceBlockUnsafeSessionArtifacts() {
        if (clinicalError) throw clinicalError;
        return {
          operation: photoProtocolReleaseGovernanceOperation,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
      ...
      async executeGovernanceIssueAccessCredentialHash() {
        if (clinicalError) throw clinicalError;
        return {
          operation: photoProtocolReleaseGovernanceOperation,
          scope: { allClinics: false, clinicIds: [STAGE4G_CLINIC_ID] },
...
test("Stage 4H · /openapi.stage4h.json documents write endpoints", async () => {
  ...
  assert.equal(response.status, 200);
  assert.equal(response.json.info.version, "4L-Q4-body-atlas-geometry");
...
test("Batch BC Stage 5H · capture metadata endpoints read and write production-safe metadata", async () => {
  const lesionId = "10000000-0000-4000-8000-000000000801";
  const assetId = "10000000-0000-4000-8000-000000000901";
  const runtime = clinicalWorkspaceRuntime({
  ...
  const read = await request(
    `/api/v1/patients/${STAGE4G_PATIENT_ID}/lesions/${lesionId}/capture-metadata`,
    configuredEnv,
    runtime,
  );
  ...
  const write = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/assets/${assetId}/capture-metadata`,
    configuredEnv,
    runtime,
    "PATCH",
    JSON.stringify({
  ...
  assert.equal(write.json.stage, "5H");
  assert.equal(write.json.item.patientDeliveryAllowed, false);
  assert.doesNotMatch(
    `${read.body}\n${write.body}`,
    /object_bucket|object_key|checksum_sha256|storage_object_path|signed_url\b|access_token|qrToken|sessionId|physicianText|patientSafeText/i,
  );
});

test("Batch BD Stage 5H · PATCH /api/v1/visits/{id}/lesion-comparison-viewer-qa saves metadata-only viewer QA", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/lesion-comparison-viewer-qa`,
    configuredEnv,
    clinicalWorkspaceRuntime({
      lesionComparisonViewerQa: {
        id: "viewer-qa-1",
        clinicId: STAGE4G_CLINIC_ID,
        patientId: STAGE4G_PATIENT_ID,
        visitId: STAGE4G_VISIT_ID,
  ...
  assert.doesNotMatch(
    response.body,
    /object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|меланома|рак кожи/i,
  );
});

test("Batch BE Stage 5H · PATCH /api/v1/visits/{id}/lesion-comparison-viewer-qa/review saves technical review metadata", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/lesion-comparison-viewer-qa/review`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.status, 200);
  assert.equal(response.json.stage, "5H");
  assert.equal(response.json.item.review.status, "needs_recapture");
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.doesNotMatch(
...
test("Batch BF Stage 5H · GET /api/v1/visits/{id}/lesion-comparison-viewer-qa/review-queue returns metadata-only queue", async () => {
  ...
  assert.equal(response.status, 200);
  assert.equal(response.json.stage, "5H");
  assert.equal(response.json.item.summary.actionable, 3);
  assert.equal(response.json.item.items[0].review.status, "needs_recapture");
  assert.equal(response.json.item.boundaries.patientDeliveryAllowed, false);
...
test("Batch BG Stage 5H · GET /api/v1/patients/{patientId}/lesions/{lesionId}/longitudinal-qa returns metadata-only readiness gate", async () => {
  const lesionId = "10000000-0000-4000-8000-000000000801";
  const response = await request(
    `/api/v1/patients/${STAGE4G_PATIENT_ID}/lesions/${lesionId}/longitudinal-qa`,
    configuredEnv,
    clinicalWorkspaceRuntime({
...
test("Batch BR Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout stores aggregate-only rollout governance", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.stage, "5H");
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "review_required");
  assert.equal(response.json.item.validationStatus, "blocked");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  ...
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|i-011|i-012|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch BS Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/sop stores aggregate-only SOP receipt", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/sop`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.item.rolloutStatus, "review_required");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
...
test("Batch BT Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/evidence stores aggregate-only evidence receipt", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/evidence`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.sopStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
...
test("Batch BU Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/monitoring stores aggregate-only monitoring outcomes", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/monitoring`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.evidenceStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|i-011|i-012|object_bucket|object_key|storage_object_path|signed_url|rawMonitoringLog|incidentPayload|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});
...
test("Batch BW Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/clinical-validation stores aggregate-only clinical validation", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/clinical-validation`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.incidentProcedureStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawValidationLog|rawAdjudicationLog|clinicalValidationPayload|validationDetails|adjudicationDetails|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch BX Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/post-validation-monitoring stores aggregate-only follow-up monitoring", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/post-validation-monitoring`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.clinicalValidationStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawMonitoringLog|rawOutcomeLog|rawValidationLog|rawDriftLog|rawFollowupLog|postValidationPayload|monitoringDetails|driftDetails|followupDetails|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});
...
test("Batch BZ Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/exception-governance stores aggregate-only exception closure", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/exception-governance`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.observationGovernanceStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawExceptionLog|rawRecurrenceLog|rawRollbackLog|exceptionPayload|recurrencePayload|rollbackPayload|exceptionDetails|recurrenceDetails|rollbackDetails|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch CA Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/outcome-governance stores aggregate-only longitudinal outcome governance", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/outcome-governance`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.exceptionGovernanceStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawOutcomeLog|rawFollowupLog|rawGovernanceLog|outcomePayload|followupPayload|governancePayload|outcomeDetails|followupDetails|governanceDetails|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch CB Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/longitudinal-clinical-validation stores aggregate-only clinical longitudinal validation", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/longitudinal-clinical-validation`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.outcomeGovernanceStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawLongitudinalClinicalValidationLog|longitudinalClinicalValidationPayload|longitudinalClinicalValidationDetails|rawAdjudicationLog|adjudicationPayload|adjudicationDetails|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch CC Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-validation stores aggregate-only protected reviewer validation", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/protected-reviewer-validation`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.longitudinalClinicalValidationStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawProtectedReviewLog|rawReviewerOpsLog|rawFollowupOpsLog|rawAdjudicationOpsLog|protectedReviewerValidationPayload|protectedReviewerValidationDetails|reviewerAssignmentPayload|secondReviewPayload|adjudicationOpsPayload|followupOpsPayload|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch CD Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-governance stores aggregate-only governance", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/protected-reviewer-governance`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.protectedReviewerValidationStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawProtectedReviewerLog|protectedReviewerGovernancePayload|protectedReviewerGovernanceDetails|reviewerMonitoringPayload|reviewerExceptionPayload|reviewerRollbackPayload|reviewerArchivePayload|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch CE Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-evidence stores aggregate-only evidence", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/protected-reviewer-evidence`,
    configuredEnv,
    clinicalWorkspaceRuntime({
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.protectedReviewerGovernanceStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
  assert.doesNotMatch(
    response.body,
    /"pairKey"|"imageIds"|patientRows|rawProtectedReviewerEvidenceLog|protectedReviewerEvidencePayload|protectedReviewerEvidenceDetails|reviewerMonitoringEvidencePayload|reviewerExceptionEvidencePayload|reviewerRollbackEvidencePayload|reviewerArchiveEvidencePayload|object_bucket|object_key|storage_object_path|signed_url|access_token|photoRef|heatmapRef|modelVersion|qrToken|sessionId|reviewerName|reviewerEmail|validatorName|validatorEmail|doctorVersionText|patientSafeText|dynamicConclusion|diagnosis|riskScore/i,
  );
});

test("Batch CF Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/production-dataset-evidence stores aggregate-only evidence", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/production-dataset-evidence`,
    configuredEnv,
    clinicalWorkspaceRuntime({
      visitLongitudinalTimelineRolloutProductionDatasetEvidence: {
  ...
  assert.equal(response.json.source, "postgres");
  assert.equal(response.json.item.status, "in_review");
  assert.equal(response.json.item.protectedReviewerEvidenceStatus, "not_started");
  assert.equal(response.json.item.patientDeliveryAllowed, false);
  assert.equal(response.json.item.medicalMeasurementAllowed, false);
  assert.equal(response.json.item.protectedFieldsExposed, false);
  assert.equal(response.json.item.clinicalOutputGenerated, false);
...
test("Batch CG Stage 5H · PATCH /api/v1/visits/{visitId}/longitudinal-timeline-rollout/production-reviewer-governance stores aggregate-only governance", async () => {
  const response = await request(
    `/api/v1/visits/${STAGE4G_VISIT_ID}/longitudinal-timeline-rollout/production-reviewer-governance`,
    configuredEnv,
    clinicalWorkspaceRuntime({
      visitLongitudinalTimelineRolloutProductionReviewerGovernance: {
        id: "production-reviewer-governance-review-1",
        clinicId: STAGE4G_CLINIC_ID,
        patientId: STAGE4G_PATIENT_ID,
        visitId: STAGE4G_VISIT_ID,
        status: "in_review",
        reasons: ["timeline_rollout_production_reviewer_governance_not_ready"],
        productionDatasetEvidenceStatus: "not_started",
        protectedReviewerEvidenceStatus: "not_started",
        protectedReviewerGovernanceStatus: "not_started",
        protectedReviewerValidationStatus: "not_started",
...
test("Stage 5H · /openapi.stage5h.json documents production clinical contracts", async () => {
  ...
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout"].patch);
  ...
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/exception-governance"].patch);
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/outcome-governance"].patch);
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/longitudinal-clinical-validation"].patch);
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-validation"].patch);
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-governance"].patch);
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-evidence"].patch);
  assert.ok(response.json.paths["/api/v1/visits/{visitId}/longitudinal-timeline-rollout/production-dataset-evidence"].patch);
  ...
  assert.ok(response.json.paths["/api/v1/patients/{patientId}/lesions/{lesionId}/capture-metadata"].get);
  ...
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRollout);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutSop);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutSopPayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutEvidence);
  ...
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutClinicalValidation);
  ...
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutExceptionGovernance);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutExceptionGovernancePayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutOutcomeGovernance);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutOutcomeGovernancePayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutLongitudinalClinicalValidation);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutLongitudinalClinicalValidationPayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProtectedReviewerValidation);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProtectedReviewerValidationPayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProtectedReviewerGovernance);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProtectedReviewerGovernancePayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProtectedReviewerEvidence);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProtectedReviewerEvidencePayload);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProductionDatasetEvidence);
  assert.ok(response.json.components.schemas.VisitLongitudinalTimelineRolloutProductionDatasetEvidencePayload);
  ...
  assert.match(JSON.stringify(response.json.components.schemas), /productionAssetNotReadyCount|productionAssetReadiness|verify_production_asset|approved_for_clinical_operations|clinicalOutputGenerated/);
});
...
test("Batch AF · patient photo protocol governance can block unapproved-retention windows safely", async () => {
  const response = await request(
    ...
    "POST",
    JSON.stringify({ confirm: true, limit: 15 }),
  );
  assert.equal(response.status, 200);
  assert.equal(response.json.stage, "8G-8I");
  assert.equal(response.json.item.operation, "block_unapproved_retention_windows");
  assert.equal(response.json.item.affectedCount, 3);
  assert.equal(response.json.item.boundaries.metadataOnly, true);
  assert.equal(response.json.item.boundaries.patientDeliveryAllowed, false);
  assert.equal(response.json.item.boundaries.temporaryCredentialsExposed, false);
  assert.equal(response.json.item.boundaries.qrTokensExposed, false);
...
test("Batch AH · patient photo protocol governance can block unsafe session artifacts safely", async () => {
  const response = await request(
    ...
    "POST",
    JSON.stringify({ confirm: true, limit: 12 }),
  );
  assert.equal(response.status, 200);
  assert.equal(response.json.stage, "8G-8I");
  assert.equal(response.json.item.operation, "block_unsafe_session_artifacts");
  assert.equal(response.json.item.affectedCount, 5);
  assert.equal(response.json.item.boundaries.metadataOnly, true);
  assert.equal(response.json.item.boundaries.patientDeliveryAllowed, false);
  assert.equal(response.json.item.boundaries.temporaryCredentialsExposed, false);
  assert.equal(response.json.item.boundaries.qrTokensExposed, false);
...
test("Batch AJ · patient photo protocol governance can issue credential hash safely", async () => {
  const response = await request(
    ...
    "POST",
    JSON.stringify({ confirm: true, limit: 7 }),
  );
  assert.equal(response.status, 200);
  assert.equal(response.json.stage, "8G-8I");
  assert.equal(response.json.item.operation, "issue_access_credential_hash");
  assert.equal(response.json.item.affectedCount, 3);
  assert.equal(response.json.item.boundaries.metadataOnly, true);
  assert.equal(response.json.item.boundaries.patientDeliveryAllowed, false);
  assert.equal(response.json.item.boundaries.temporaryCredentialsExposed, false);
  assert.equal(response.json.item.boundaries.qrTokensExposed, false);
  assert.equal(response.json.item.boundaries.sessionIdsExposed, false);
  assert.equal(response.json.item.boundaries.rawCredentialExposed, false);
  assert.equal(response.json.item.boundaries.credentialHashExposed, false);
  assert.equal(response.json.item.boundaries.credentialFingerprintExposed, false);
  assert.doesNotMatch(response.body, /patientFullName|patient_id|visitId|releaseId|object_bucket|object_key|storage_object_path|signed_url|access_token|rawCredential"\s*:|credentialHash"\s*:|credentialFingerprint"\s*:|revokeReason"\s*:|physician_text|doctorVersionText/i);
});
...
test("Stage 8G-8I · /openapi.stage8g-8i.json documents clinical report package", async () => {
  ...
  assert.ok(response.json.paths["/api/v1/patient-photo-protocol-release/governance/issue-access-credential-hash"].post);
