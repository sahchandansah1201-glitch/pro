...
from (
  ...
  latest_exception_governance as (
    select
      x.id,
      x.clinic_id,
      x.patient_id,
      x.visit_id,
      x.exception_governance_status,
      x.exception_governance_reasons,
      x.observation_governance_status,
      x.post_validation_monitoring_status,
      x.clinical_validation_status,
      x.incident_procedure_status,
      x.monitoring_status,
      x.evidence_status,
      x.sop_status,
      x.dataset_validation_status,
      x.rollout_status,
      x.exception_register_status,
      x.triage_sla_status,
      x.resolution_evidence_status,
      x.recurrence_review_status,
      x.rollback_readiness_status,
      x.governance_archive_status,
      x.owner_signoff_status,
      x.real_dataset_timeline_count,
      x.observed_timeline_count,
      x.governance_exception_count,
      x.resolved_governance_exception_count,
      x.unresolved_governance_exception_count,
      x.recurrence_signal_count,
      x.unresolved_recurrence_signal_count,
      x.rollback_drill_count,
      x.blocker_count,
      x.lesion_count,
      x.ready_timeline_count,
      x.blocked_timeline_count,
      x.candidate_pair_count,
      x.reviewer_workflow_ready_count,
      x.reviewed_at,
      x.created_at,
      x.updated_at
    from visit_longitudinal_timeline_rollout_exception_governance_reviews x
    join target_visit v
      on x.visit_id = v.id
     and x.patient_id = v.patient_id
     and x.clinic_id = v.clinic_id
    where x.patient_delivery_allowed = false
      and x.medical_measurement_allowed = false
      and x.protected_fields_exposed = false
      and x.clinical_output_generated = false
      ${clinicScopeWhere({ alias: "x", clinicIds, allClinics })}
    order by x.updated_at desc
    limit 1
  ),
  latest_outcome_governance as (
    select
      o.id,
      o.clinic_id,
      o.patient_id,
      o.visit_id,
      o.outcome_governance_status,
      o.outcome_governance_reasons,
      o.exception_governance_status,
      o.observation_governance_status,
      o.post_validation_monitoring_status,
      o.clinical_validation_status,
      o.incident_procedure_status,
      o.monitoring_status,
      o.evidence_status,
      o.sop_status,
      o.dataset_validation_status,
      o.rollout_status,
      o.longitudinal_window_status,
      o.real_dataset_coverage_status,
      o.reviewer_operations_validation_status,
      o.exception_trend_review_status,
      o.followup_cadence_status,
      o.governance_cadence_status,
      o.owner_signoff_status,
      o.real_dataset_timeline_count,
      o.observed_timeline_count,
      o.followup_window_count,
      o.completed_followup_count,
      o.governance_exception_count,
      o.unresolved_governance_exception_count,
      o.recurrence_signal_count,
      o.unresolved_recurrence_signal_count,
      o.governance_review_count,
      o.blocker_count,
      o.lesion_count,
      o.ready_timeline_count,
      o.blocked_timeline_count,
      o.candidate_pair_count,
      o.reviewer_workflow_ready_count,
      o.reviewed_at,
      o.created_at,
      o.updated_at
    from visit_longitudinal_timeline_rollout_outcome_governance_reviews o
    join target_visit v
      on o.visit_id = v.id
     and o.patient_id = v.patient_id
     and o.clinic_id = v.clinic_id
    where o.patient_delivery_allowed = false
      and o.medical_measurement_allowed = false
      and o.protected_fields_exposed = false
      and o.clinical_output_generated = false
      ${clinicScopeWhere({ alias: "o", clinicIds, allClinics })}
    order by o.updated_at desc
    limit 1
  ),
  latest_longitudinal_clinical_validation as (
    select
      l.id,
      l.clinic_id,
      l.patient_id,
      l.visit_id,
      l.longitudinal_clinical_validation_status,
      l.longitudinal_clinical_validation_reasons,
      l.outcome_governance_status,
      l.exception_governance_status,
      l.observation_governance_status,
      l.post_validation_monitoring_status,
      l.clinical_validation_status,
      l.incident_procedure_status,
      l.monitoring_status,
      l.evidence_status,
      l.sop_status,
      l.dataset_validation_status,
      l.rollout_status,
      l.outcome_window_status,
      l.clinician_coverage_status,
      l.adjudication_status,
      l.consensus_review_status,
      l.followup_validation_status,
      l.governance_cadence_status,
      l.owner_signoff_status,
      l.real_outcome_window_count,
      l.clinically_validated_window_count,
      l.adjudicated_window_count,
      l.followup_validated_window_count,
      l.consensus_review_count,
      l.unresolved_consensus_case_count,
      l.governance_review_count,
      l.blocker_count,
      l.lesion_count,
      l.ready_timeline_count,
      l.blocked_timeline_count,
      l.candidate_pair_count,
      l.reviewer_workflow_ready_count,
      l.reviewed_at,
      l.created_at,
      l.updated_at
    from visit_longitudinal_timeline_rollout_longitudinal_clinical_validation_reviews l
    join target_visit v
      on l.visit_id = v.id
     and l.patient_id = v.patient_id
     and l.clinic_id = v.clinic_id
    where l.patient_delivery_allowed = false
      and l.medical_measurement_allowed = false
      and l.protected_fields_exposed = false
      and l.clinical_output_generated = false
      ${clinicScopeWhere({ alias: "l", clinicIds, allClinics })}
  ...
  latest_protected_reviewer_governance as (
    select
      g.id,
      g.clinic_id,
      g.patient_id,
      g.visit_id,
      g.protected_reviewer_governance_status,
      g.protected_reviewer_governance_reasons,
      g.protected_reviewer_validation_status,
      g.longitudinal_clinical_validation_status,
      g.outcome_governance_status,
      g.exception_governance_status,
      g.observation_governance_status,
      g.post_validation_monitoring_status,
      g.clinical_validation_status,
      g.incident_procedure_status,
      ...
      g.dataset_validation_status,
      g.rollout_status,
      g.reviewer_monitoring_status,
      g.reviewer_exception_status,
      g.reviewer_adjudication_status,
      g.reviewer_followup_status,
      g.reviewer_rollback_status,
      g.reviewer_archive_status,
      g.owner_signoff_status,
      g.protected_review_window_count,
      g.monitored_protected_review_count,
      g.escalated_protected_review_count,
      g.adjudicated_protected_governance_count,
      g.followup_closed_protected_count,
      g.rollback_ready_protected_count,
      g.archived_protected_review_count,
      g.unresolved_governance_review_count,
      g.blocker_count,
      g.lesion_count,
      g.ready_timeline_count,
      g.blocked_timeline_count,
      ...
      g.created_at,
      g.updated_at
    from visit_longitudinal_timeline_rollout_protected_reviewer_governance_reviews g
    join target_visit v
      on g.visit_id = v.id
     and g.patient_id = v.patient_id
     and g.clinic_id = v.clinic_id
  ...
  latest_protected_reviewer_evidence as (
    select
      e.id,
      e.clinic_id,
      e.patient_id,
      e.visit_id,
      e.protected_reviewer_evidence_status,
      e.protected_reviewer_evidence_reasons,
      e.protected_reviewer_governance_status,
      e.protected_reviewer_validation_status,
      e.longitudinal_clinical_validation_status,
      e.outcome_governance_status,
      e.exception_governance_status,
      e.observation_governance_status,
      e.post_validation_monitoring_status,
      e.clinical_validation_status,
      e.incident_procedure_status,
      e.monitoring_status,
      e.evidence_status,
      e.sop_status,
      e.dataset_validation_status,
      e.rollout_status,
      e.reviewer_monitoring_evidence_status,
      e.reviewer_exception_evidence_status,
      e.reviewer_adjudication_evidence_status,
      e.reviewer_followup_evidence_status,
      e.reviewer_rollback_evidence_status,
      e.reviewer_archive_evidence_status,
      e.owner_signoff_status,
      e.protected_review_window_count,
      e.monitored_protected_review_count,
      e.sampled_protected_review_count,
      e.adjudicated_protected_evidence_count,
      e.followup_closed_protected_count,
      e.rollback_drill_protected_count,
      e.archived_protected_review_count,
      e.unresolved_protected_evidence_count,
      e.blocker_count,
      e.lesion_count,
      e.ready_timeline_count,
      e.blocked_timeline_count,
      ...
      e.created_at,
      e.updated_at
    from visit_longitudinal_timeline_rollout_protected_reviewer_evidence_reviews e
    join target_visit v
      on e.visit_id = v.id
     and e.patient_id = v.patient_id
     and e.clinic_id = v.clinic_id
  ...
  latest_production_dataset_evidence as (
    select
      p.id,
      p.clinic_id,
      p.patient_id,
      p.visit_id,
      p.production_dataset_evidence_status,
      p.production_dataset_evidence_reasons,
      p.protected_reviewer_evidence_status,
      p.protected_reviewer_governance_status,
      p.protected_reviewer_validation_status,
      p.longitudinal_clinical_validation_status,
      p.outcome_governance_status,
      p.exception_governance_status,
      ...
      p.dataset_validation_status,
      p.rollout_status,
      p.real_clinic_window_status,
      p.dataset_sampling_status,
      p.longitudinal_followup_status,
      p.protected_reviewer_linkage_status,
      p.outcome_observation_status,
      p.incident_linkage_status,
      p.owner_signoff_status,
      p.real_clinic_window_count,
      p.monitored_clinic_operation_count,
      p.sampled_clinic_operation_count,
      p.longitudinal_followup_count,
      p.protected_reviewer_linked_count,
      p.observed_outcome_count,
      p.incident_linked_count,
      p.unresolved_production_dataset_evidence_count,
      p.blocker_count,
      p.lesion_count,
      p.ready_timeline_count,
      p.blocked_timeline_count,
      ...
      p.created_at,
      p.updated_at
    from visit_longitudinal_timeline_rollout_production_dataset_evidence_reviews p
    join target_visit v
      on p.visit_id = v.id
     and p.patient_id = v.patient_id
     and p.clinic_id = v.clinic_id
  ...
  latest_production_reviewer_rollback_evidence as (
    select
      p.id,
      p.clinic_id,
      p.patient_id,
      p.visit_id,
      p.production_reviewer_rollback_evidence_status,
      p.production_reviewer_rollback_evidence_reasons,
      p.production_dataset_evidence_status,
      p.rollback_drill_status,
      p.rollback_owner_status,
      p.rollback_window_status,
      p.rollback_exception_status,
      p.rollback_archive_status,
      p.owner_signoff_status,
      p.production_review_window_count,
      p.rollback_drill_production_count,
      p.rollback_ready_production_count,
      p.rollback_exception_count,
      p.unresolved_rollback_evidence_count,
      p.blocker_count,
      p.lesion_count,
      p.ready_timeline_count,
      p.blocked_timeline_count,
      ...
      p.created_at,
      p.updated_at
    from visit_longitudinal_timeline_rollout_production_reviewer_rollback_evidence_reviews p
    join target_visit v
      on p.visit_id = v.id
     and p.patient_id = v.patient_id
     and p.clinic_id = v.clinic_id
  ...
  latest_production_reviewer_governance as (
    select
      p.id,
      p.clinic_id,
      p.patient_id,
      p.visit_id,
      p.production_reviewer_governance_status,
      p.production_reviewer_governance_reasons,
      p.production_dataset_evidence_status,
      p.protected_reviewer_evidence_status,
      p.protected_reviewer_governance_status,
      p.protected_reviewer_validation_status,
      ...
      p.dataset_validation_status,
      p.rollout_status,
      p.production_reviewer_assignment_status,
      p.production_second_review_status,
      p.production_adjudication_status,
      p.production_followup_status,
      p.production_exception_status,
      p.production_rollback_status,
      p.owner_signoff_status,
      p.production_review_window_count,
      p.assigned_production_reviewer_count,
      p.second_reviewed_production_count,
      p.adjudicated_production_review_count,
      p.followup_closed_production_count,
      p.exception_closed_production_count,
      p.rollback_ready_production_count,
      p.unresolved_production_reviewer_governance_count,
      p.blocker_count,
      p.lesion_count,
      p.ready_timeline_count,
      p.blocked_timeline_count,
      ...
      p.created_at,
      p.updated_at
    from visit_longitudinal_timeline_rollout_production_reviewer_governance_reviews p
    join target_visit v
      on p.visit_id = v.id
     and p.patient_id = v.patient_id
     and p.clinic_id = v.clinic_id
  ...
  latest_production_reviewer_evidence as (
    select
      p.id,
      p.clinic_id,
      p.patient_id,
      p.visit_id,
      p.production_reviewer_evidence_status,
      p.production_reviewer_evidence_reasons,
      p.production_dataset_evidence_status,
      p.production_reviewer_governance_status,
      p.protected_reviewer_evidence_status,
      p.protected_reviewer_governance_status,
      ...
      p.exception_closed_production_count,
      p.rollback_ready_production_count,
      p.unresolved_production_reviewer_evidence_count,
      p.blocker_count,
      p.lesion_count,
      p.ready_timeline_count,
      p.blocked_timeline_count,
      ...
      p.created_at,
      p.updated_at
    from visit_longitudinal_timeline_rollout_production_reviewer_evidence_reviews p
    join target_visit v
      on p.visit_id = v.id
     and p.patient_id = v.patient_id
     and p.clinic_id = v.clinic_id
  ...
  select
    ...
    jsonb_build_object(
      'id', coalesce((select id::text from latest_exception_governance), ''),
      'clinicId', coalesce((select clinic_id::text from latest_exception_governance), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_exception_governance), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_exception_governance), v.id::text),
      'status', coalesce((select exception_governance_status from latest_exception_governance), 'not_started'),
      'reasons', coalesce((select exception_governance_reasons from latest_exception_governance), '[]'::jsonb),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_exception_governance), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_exception_governance), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_exception_governance), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_exception_governance), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_exception_governance), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_exception_governance), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_exception_governance), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_exception_governance), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_exception_governance), 'not_approved'),
      'exceptionRegisterStatus', coalesce((select exception_register_status from latest_exception_governance), 'missing'),
      'triageSlaStatus', coalesce((select triage_sla_status from latest_exception_governance), 'missing'),
      'resolutionEvidenceStatus', coalesce((select resolution_evidence_status from latest_exception_governance), 'missing'),
      'recurrenceReviewStatus', coalesce((select recurrence_review_status from latest_exception_governance), 'missing'),
      'rollbackReadinessStatus', coalesce((select rollback_readiness_status from latest_exception_governance), 'missing'),
      'governanceArchiveStatus', coalesce((select governance_archive_status from latest_exception_governance), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_exception_governance), 'missing'),
      'realDatasetTimelineCount', coalesce((select real_dataset_timeline_count from latest_exception_governance), 0),
      'observedTimelineCount', coalesce((select observed_timeline_count from latest_exception_governance), 0),
      'governanceExceptionCount', coalesce((select governance_exception_count from latest_exception_governance), 0),
      'resolvedGovernanceExceptionCount', coalesce((select resolved_governance_exception_count from latest_exception_governance), 0),
      'unresolvedGovernanceExceptionCount', coalesce((select unresolved_governance_exception_count from latest_exception_governance), 0),
      'recurrenceSignalCount', coalesce((select recurrence_signal_count from latest_exception_governance), 0),
      'unresolvedRecurrenceSignalCount', coalesce((select unresolved_recurrence_signal_count from latest_exception_governance), 0),
      'rollbackDrillCount', coalesce((select rollback_drill_count from latest_exception_governance), 0),
      'blockerCount', coalesce((select blocker_count from latest_exception_governance), 0),
      'lesionCount', coalesce((select lesion_count from latest_exception_governance), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_exception_governance), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_exception_governance), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_exception_governance), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_exception_governance), 0),
      'reviewedAt', (select reviewed_at from latest_exception_governance),
      'createdAt', (select created_at from latest_exception_governance),
      'updatedAt', (select updated_at from latest_exception_governance),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutExceptionGovernance",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_outcome_governance), ''),
      'clinicId', coalesce((select clinic_id::text from latest_outcome_governance), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_outcome_governance), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_outcome_governance), v.id::text),
      'status', coalesce((select outcome_governance_status from latest_outcome_governance), 'not_started'),
      'reasons', coalesce((select outcome_governance_reasons from latest_outcome_governance), '[]'::jsonb),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_outcome_governance), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_outcome_governance), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_outcome_governance), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_outcome_governance), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_outcome_governance), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_outcome_governance), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_outcome_governance), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_outcome_governance), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_outcome_governance), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_outcome_governance), 'not_approved'),
      'longitudinalWindowStatus', coalesce((select longitudinal_window_status from latest_outcome_governance), 'missing'),
      'realDatasetCoverageStatus', coalesce((select real_dataset_coverage_status from latest_outcome_governance), 'missing'),
      'reviewerOperationsValidationStatus', coalesce((select reviewer_operations_validation_status from latest_outcome_governance), 'missing'),
      'exceptionTrendReviewStatus', coalesce((select exception_trend_review_status from latest_outcome_governance), 'missing'),
      'followupCadenceStatus', coalesce((select followup_cadence_status from latest_outcome_governance), 'missing'),
      'governanceCadenceStatus', coalesce((select governance_cadence_status from latest_outcome_governance), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_outcome_governance), 'missing'),
      'realDatasetTimelineCount', coalesce((select real_dataset_timeline_count from latest_outcome_governance), 0),
      'observedTimelineCount', coalesce((select observed_timeline_count from latest_outcome_governance), 0),
      'followupWindowCount', coalesce((select followup_window_count from latest_outcome_governance), 0),
      'completedFollowupCount', coalesce((select completed_followup_count from latest_outcome_governance), 0),
      'governanceExceptionCount', coalesce((select governance_exception_count from latest_outcome_governance), 0),
      'unresolvedGovernanceExceptionCount', coalesce((select unresolved_governance_exception_count from latest_outcome_governance), 0),
      'recurrenceSignalCount', coalesce((select recurrence_signal_count from latest_outcome_governance), 0),
      'unresolvedRecurrenceSignalCount', coalesce((select unresolved_recurrence_signal_count from latest_outcome_governance), 0),
      'governanceReviewCount', coalesce((select governance_review_count from latest_outcome_governance), 0),
      'blockerCount', coalesce((select blocker_count from latest_outcome_governance), 0),
      'lesionCount', coalesce((select lesion_count from latest_outcome_governance), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_outcome_governance), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_outcome_governance), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_outcome_governance), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_outcome_governance), 0),
      'reviewedAt', (select reviewed_at from latest_outcome_governance),
      'createdAt', (select created_at from latest_outcome_governance),
      'updatedAt', (select updated_at from latest_outcome_governance),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutOutcomeGovernance",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_longitudinal_clinical_validation), ''),
      'clinicId', coalesce((select clinic_id::text from latest_longitudinal_clinical_validation), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_longitudinal_clinical_validation), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_longitudinal_clinical_validation), v.id::text),
      'status', coalesce((select longitudinal_clinical_validation_status from latest_longitudinal_clinical_validation), 'not_started'),
      'reasons', coalesce((select longitudinal_clinical_validation_reasons from latest_longitudinal_clinical_validation), '[]'::jsonb),
      'outcomeGovernanceStatus', coalesce((select outcome_governance_status from latest_longitudinal_clinical_validation), 'not_started'),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_longitudinal_clinical_validation), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_longitudinal_clinical_validation), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_longitudinal_clinical_validation), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_longitudinal_clinical_validation), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_longitudinal_clinical_validation), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_longitudinal_clinical_validation), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_longitudinal_clinical_validation), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_longitudinal_clinical_validation), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_longitudinal_clinical_validation), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_longitudinal_clinical_validation), 'not_approved'),
      'outcomeWindowStatus', coalesce((select outcome_window_status from latest_longitudinal_clinical_validation), 'missing'),
      'clinicianCoverageStatus', coalesce((select clinician_coverage_status from latest_longitudinal_clinical_validation), 'missing'),
      'adjudicationStatus', coalesce((select adjudication_status from latest_longitudinal_clinical_validation), 'missing'),
      'consensusReviewStatus', coalesce((select consensus_review_status from latest_longitudinal_clinical_validation), 'missing'),
      'followupValidationStatus', coalesce((select followup_validation_status from latest_longitudinal_clinical_validation), 'missing'),
      'governanceCadenceStatus', coalesce((select governance_cadence_status from latest_longitudinal_clinical_validation), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_longitudinal_clinical_validation), 'missing'),
      'realOutcomeWindowCount', coalesce((select real_outcome_window_count from latest_longitudinal_clinical_validation), 0),
      'clinicallyValidatedWindowCount', coalesce((select clinically_validated_window_count from latest_longitudinal_clinical_validation), 0),
      'adjudicatedWindowCount', coalesce((select adjudicated_window_count from latest_longitudinal_clinical_validation), 0),
      'followupValidatedWindowCount', coalesce((select followup_validated_window_count from latest_longitudinal_clinical_validation), 0),
      'consensusReviewCount', coalesce((select consensus_review_count from latest_longitudinal_clinical_validation), 0),
      'unresolvedConsensusCaseCount', coalesce((select unresolved_consensus_case_count from latest_longitudinal_clinical_validation), 0),
      'governanceReviewCount', coalesce((select governance_review_count from latest_longitudinal_clinical_validation), 0),
      'blockerCount', coalesce((select blocker_count from latest_longitudinal_clinical_validation), 0),
      'lesionCount', coalesce((select lesion_count from latest_longitudinal_clinical_validation), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_longitudinal_clinical_validation), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_longitudinal_clinical_validation), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_longitudinal_clinical_validation), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_longitudinal_clinical_validation), 0),
      'reviewedAt', (select reviewed_at from latest_longitudinal_clinical_validation),
      'createdAt', (select created_at from latest_longitudinal_clinical_validation),
      'updatedAt', (select updated_at from latest_longitudinal_clinical_validation),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ...
    jsonb_build_object(
      'id', coalesce((select id::text from latest_protected_reviewer_governance), ''),
      'clinicId', coalesce((select clinic_id::text from latest_protected_reviewer_governance), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_protected_reviewer_governance), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_protected_reviewer_governance), v.id::text),
      'status', coalesce((select protected_reviewer_governance_status from latest_protected_reviewer_governance), 'not_started'),
      'reasons', coalesce((select protected_reviewer_governance_reasons from latest_protected_reviewer_governance), '[]'::jsonb),
      'protectedReviewerValidationStatus', coalesce((select protected_reviewer_validation_status from latest_protected_reviewer_governance), 'not_started'),
      'longitudinalClinicalValidationStatus', coalesce((select longitudinal_clinical_validation_status from latest_protected_reviewer_governance), 'not_started'),
      'outcomeGovernanceStatus', coalesce((select outcome_governance_status from latest_protected_reviewer_governance), 'not_started'),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_protected_reviewer_governance), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_protected_reviewer_governance), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_protected_reviewer_governance), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_protected_reviewer_governance), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_protected_reviewer_governance), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_protected_reviewer_governance), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_protected_reviewer_governance), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_protected_reviewer_governance), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_protected_reviewer_governance), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_protected_reviewer_governance), 'not_approved'),
      'reviewerMonitoringStatus', coalesce((select reviewer_monitoring_status from latest_protected_reviewer_governance), 'missing'),
      'reviewerExceptionStatus', coalesce((select reviewer_exception_status from latest_protected_reviewer_governance), 'missing'),
      'reviewerAdjudicationStatus', coalesce((select reviewer_adjudication_status from latest_protected_reviewer_governance), 'missing'),
      'reviewerFollowupStatus', coalesce((select reviewer_followup_status from latest_protected_reviewer_governance), 'missing'),
      'reviewerRollbackStatus', coalesce((select reviewer_rollback_status from latest_protected_reviewer_governance), 'missing'),
      'reviewerArchiveStatus', coalesce((select reviewer_archive_status from latest_protected_reviewer_governance), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_protected_reviewer_governance), 'missing'),
      'protectedReviewWindowCount', coalesce((select protected_review_window_count from latest_protected_reviewer_governance), 0),
      'monitoredProtectedReviewCount', coalesce((select monitored_protected_review_count from latest_protected_reviewer_governance), 0),
      'escalatedProtectedReviewCount', coalesce((select escalated_protected_review_count from latest_protected_reviewer_governance), 0),
      'adjudicatedProtectedGovernanceCount', coalesce((select adjudicated_protected_governance_count from latest_protected_reviewer_governance), 0),
      'followupClosedProtectedCount', coalesce((select followup_closed_protected_count from latest_protected_reviewer_governance), 0),
      'rollbackReadyProtectedCount', coalesce((select rollback_ready_protected_count from latest_protected_reviewer_governance), 0),
      'archivedProtectedReviewCount', coalesce((select archived_protected_review_count from latest_protected_reviewer_governance), 0),
      'unresolvedGovernanceReviewCount', coalesce((select unresolved_governance_review_count from latest_protected_reviewer_governance), 0),
      'blockerCount', coalesce((select blocker_count from latest_protected_reviewer_governance), 0),
      'lesionCount', coalesce((select lesion_count from latest_protected_reviewer_governance), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_protected_reviewer_governance), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_protected_reviewer_governance), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_protected_reviewer_governance), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_protected_reviewer_governance), 0),
      'reviewedAt', (select reviewed_at from latest_protected_reviewer_governance),
      'createdAt', (select created_at from latest_protected_reviewer_governance),
      'updatedAt', (select updated_at from latest_protected_reviewer_governance),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutProtectedReviewerGovernance",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_protected_reviewer_evidence), ''),
      'clinicId', coalesce((select clinic_id::text from latest_protected_reviewer_evidence), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_protected_reviewer_evidence), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_protected_reviewer_evidence), v.id::text),
      'status', coalesce((select protected_reviewer_evidence_status from latest_protected_reviewer_evidence), 'not_started'),
      'reasons', coalesce((select protected_reviewer_evidence_reasons from latest_protected_reviewer_evidence), '[]'::jsonb),
      'protectedReviewerGovernanceStatus', coalesce((select protected_reviewer_governance_status from latest_protected_reviewer_evidence), 'not_started'),
      'protectedReviewerValidationStatus', coalesce((select protected_reviewer_validation_status from latest_protected_reviewer_evidence), 'not_started'),
      'longitudinalClinicalValidationStatus', coalesce((select longitudinal_clinical_validation_status from latest_protected_reviewer_evidence), 'not_started'),
      'outcomeGovernanceStatus', coalesce((select outcome_governance_status from latest_protected_reviewer_evidence), 'not_started'),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_protected_reviewer_evidence), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_protected_reviewer_evidence), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_protected_reviewer_evidence), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_protected_reviewer_evidence), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_protected_reviewer_evidence), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_protected_reviewer_evidence), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_protected_reviewer_evidence), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_protected_reviewer_evidence), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_protected_reviewer_evidence), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_protected_reviewer_evidence), 'not_approved'),
      'reviewerMonitoringEvidenceStatus', coalesce((select reviewer_monitoring_evidence_status from latest_protected_reviewer_evidence), 'missing'),
      'reviewerExceptionEvidenceStatus', coalesce((select reviewer_exception_evidence_status from latest_protected_reviewer_evidence), 'missing'),
      'reviewerAdjudicationEvidenceStatus', coalesce((select reviewer_adjudication_evidence_status from latest_protected_reviewer_evidence), 'missing'),
      'reviewerFollowupEvidenceStatus', coalesce((select reviewer_followup_evidence_status from latest_protected_reviewer_evidence), 'missing'),
      'reviewerRollbackEvidenceStatus', coalesce((select reviewer_rollback_evidence_status from latest_protected_reviewer_evidence), 'missing'),
      'reviewerArchiveEvidenceStatus', coalesce((select reviewer_archive_evidence_status from latest_protected_reviewer_evidence), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_protected_reviewer_evidence), 'missing'),
      'protectedReviewWindowCount', coalesce((select protected_review_window_count from latest_protected_reviewer_evidence), 0),
      'monitoredProtectedReviewCount', coalesce((select monitored_protected_review_count from latest_protected_reviewer_evidence), 0),
      'sampledProtectedReviewCount', coalesce((select sampled_protected_review_count from latest_protected_reviewer_evidence), 0),
      'adjudicatedProtectedEvidenceCount', coalesce((select adjudicated_protected_evidence_count from latest_protected_reviewer_evidence), 0),
      'followupClosedProtectedCount', coalesce((select followup_closed_protected_count from latest_protected_reviewer_evidence), 0),
      'rollbackDrillProtectedCount', coalesce((select rollback_drill_protected_count from latest_protected_reviewer_evidence), 0),
      'archivedProtectedReviewCount', coalesce((select archived_protected_review_count from latest_protected_reviewer_evidence), 0),
      'unresolvedProtectedEvidenceCount', coalesce((select unresolved_protected_evidence_count from latest_protected_reviewer_evidence), 0),
      'blockerCount', coalesce((select blocker_count from latest_protected_reviewer_evidence), 0),
      'lesionCount', coalesce((select lesion_count from latest_protected_reviewer_evidence), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_protected_reviewer_evidence), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_protected_reviewer_evidence), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_protected_reviewer_evidence), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_protected_reviewer_evidence), 0),
      'reviewedAt', (select reviewed_at from latest_protected_reviewer_evidence),
      'createdAt', (select created_at from latest_protected_reviewer_evidence),
      'updatedAt', (select updated_at from latest_protected_reviewer_evidence),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutProtectedReviewerEvidence",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_production_dataset_evidence), ''),
      'clinicId', coalesce((select clinic_id::text from latest_production_dataset_evidence), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_production_dataset_evidence), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_production_dataset_evidence), v.id::text),
      'status', coalesce((select production_dataset_evidence_status from latest_production_dataset_evidence), 'not_started'),
      'reasons', coalesce((select production_dataset_evidence_reasons from latest_production_dataset_evidence), '[]'::jsonb),
      'protectedReviewerEvidenceStatus', coalesce((select protected_reviewer_evidence_status from latest_production_dataset_evidence), 'not_started'),
      'protectedReviewerGovernanceStatus', coalesce((select protected_reviewer_governance_status from latest_production_dataset_evidence), 'not_started'),
      'protectedReviewerValidationStatus', coalesce((select protected_reviewer_validation_status from latest_production_dataset_evidence), 'not_started'),
      'longitudinalClinicalValidationStatus', coalesce((select longitudinal_clinical_validation_status from latest_production_dataset_evidence), 'not_started'),
      'outcomeGovernanceStatus', coalesce((select outcome_governance_status from latest_production_dataset_evidence), 'not_started'),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_production_dataset_evidence), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_production_dataset_evidence), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_production_dataset_evidence), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_production_dataset_evidence), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_production_dataset_evidence), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_production_dataset_evidence), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_production_dataset_evidence), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_production_dataset_evidence), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_production_dataset_evidence), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_production_dataset_evidence), 'not_approved'),
      'realClinicWindowStatus', coalesce((select real_clinic_window_status from latest_production_dataset_evidence), 'missing'),
      'datasetSamplingStatus', coalesce((select dataset_sampling_status from latest_production_dataset_evidence), 'missing'),
      'longitudinalFollowupStatus', coalesce((select longitudinal_followup_status from latest_production_dataset_evidence), 'missing'),
      'protectedReviewerLinkageStatus', coalesce((select protected_reviewer_linkage_status from latest_production_dataset_evidence), 'missing'),
      'outcomeObservationStatus', coalesce((select outcome_observation_status from latest_production_dataset_evidence), 'missing'),
      'incidentLinkageStatus', coalesce((select incident_linkage_status from latest_production_dataset_evidence), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_production_dataset_evidence), 'missing'),
      'realClinicWindowCount', coalesce((select real_clinic_window_count from latest_production_dataset_evidence), 0),
      'monitoredClinicOperationCount', coalesce((select monitored_clinic_operation_count from latest_production_dataset_evidence), 0),
      'sampledClinicOperationCount', coalesce((select sampled_clinic_operation_count from latest_production_dataset_evidence), 0),
      'longitudinalFollowupCount', coalesce((select longitudinal_followup_count from latest_production_dataset_evidence), 0),
      'protectedReviewerLinkedCount', coalesce((select protected_reviewer_linked_count from latest_production_dataset_evidence), 0),
      'observedOutcomeCount', coalesce((select observed_outcome_count from latest_production_dataset_evidence), 0),
      'incidentLinkedCount', coalesce((select incident_linked_count from latest_production_dataset_evidence), 0),
      'unresolvedProductionDatasetEvidenceCount', coalesce((select unresolved_production_dataset_evidence_count from latest_production_dataset_evidence), 0),
      'blockerCount', coalesce((select blocker_count from latest_production_dataset_evidence), 0),
      'lesionCount', coalesce((select lesion_count from latest_production_dataset_evidence), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_production_dataset_evidence), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_production_dataset_evidence), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_production_dataset_evidence), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_production_dataset_evidence), 0),
      'reviewedAt', (select reviewed_at from latest_production_dataset_evidence),
      'createdAt', (select created_at from latest_production_dataset_evidence),
      'updatedAt', (select updated_at from latest_production_dataset_evidence),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutProductionDatasetEvidence",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_production_reviewer_rollback_evidence), ''),
      'clinicId', coalesce((select clinic_id::text from latest_production_reviewer_rollback_evidence), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_production_reviewer_rollback_evidence), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_production_reviewer_rollback_evidence), v.id::text),
      'status', coalesce((select production_reviewer_rollback_evidence_status from latest_production_reviewer_rollback_evidence), 'not_started'),
      'reasons', coalesce((select production_reviewer_rollback_evidence_reasons from latest_production_reviewer_rollback_evidence), '[]'::jsonb),
      'productionDatasetEvidenceStatus', coalesce((select production_dataset_evidence_status from latest_production_reviewer_rollback_evidence), 'not_started'),
      'rollbackDrillStatus', coalesce((select rollback_drill_status from latest_production_reviewer_rollback_evidence), 'missing'),
      'rollbackOwnerStatus', coalesce((select rollback_owner_status from latest_production_reviewer_rollback_evidence), 'missing'),
      'rollbackWindowStatus', coalesce((select rollback_window_status from latest_production_reviewer_rollback_evidence), 'missing'),
      'rollbackExceptionStatus', coalesce((select rollback_exception_status from latest_production_reviewer_rollback_evidence), 'missing'),
      'rollbackArchiveStatus', coalesce((select rollback_archive_status from latest_production_reviewer_rollback_evidence), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_production_reviewer_rollback_evidence), 'missing'),
      'productionReviewWindowCount', coalesce((select production_review_window_count from latest_production_reviewer_rollback_evidence), 0),
      'rollbackDrillProductionCount', coalesce((select rollback_drill_production_count from latest_production_reviewer_rollback_evidence), 0),
      'rollbackReadyProductionCount', coalesce((select rollback_ready_production_count from latest_production_reviewer_rollback_evidence), 0),
      'rollbackExceptionCount', coalesce((select rollback_exception_count from latest_production_reviewer_rollback_evidence), 0),
      'unresolvedRollbackEvidenceCount', coalesce((select unresolved_rollback_evidence_count from latest_production_reviewer_rollback_evidence), 0),
      'blockerCount', coalesce((select blocker_count from latest_production_reviewer_rollback_evidence), 0),
      'lesionCount', coalesce((select lesion_count from latest_production_reviewer_rollback_evidence), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_production_reviewer_rollback_evidence), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_production_reviewer_rollback_evidence), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_production_reviewer_rollback_evidence), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_production_reviewer_rollback_evidence), 0),
      'reviewedAt', (select reviewed_at from latest_production_reviewer_rollback_evidence),
      'createdAt', (select created_at from latest_production_reviewer_rollback_evidence),
      'updatedAt', (select updated_at from latest_production_reviewer_rollback_evidence),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutProductionReviewerRollbackEvidence",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_production_reviewer_governance), ''),
      'clinicId', coalesce((select clinic_id::text from latest_production_reviewer_governance), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_production_reviewer_governance), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_production_reviewer_governance), v.id::text),
      'status', coalesce((select production_reviewer_governance_status from latest_production_reviewer_governance), 'not_started'),
      'reasons', coalesce((select production_reviewer_governance_reasons from latest_production_reviewer_governance), '[]'::jsonb),
      'productionDatasetEvidenceStatus', coalesce((select production_dataset_evidence_status from latest_production_reviewer_governance), 'not_started'),
      'protectedReviewerEvidenceStatus', coalesce((select protected_reviewer_evidence_status from latest_production_reviewer_governance), 'not_started'),
      'protectedReviewerGovernanceStatus', coalesce((select protected_reviewer_governance_status from latest_production_reviewer_governance), 'not_started'),
      'protectedReviewerValidationStatus', coalesce((select protected_reviewer_validation_status from latest_production_reviewer_governance), 'not_started'),
      'longitudinalClinicalValidationStatus', coalesce((select longitudinal_clinical_validation_status from latest_production_reviewer_governance), 'not_started'),
      'outcomeGovernanceStatus', coalesce((select outcome_governance_status from latest_production_reviewer_governance), 'not_started'),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_production_reviewer_governance), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_production_reviewer_governance), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_production_reviewer_governance), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_production_reviewer_governance), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_production_reviewer_governance), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_production_reviewer_governance), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_production_reviewer_governance), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_production_reviewer_governance), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_production_reviewer_governance), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_production_reviewer_governance), 'not_approved'),
      'productionReviewerAssignmentStatus', coalesce((select production_reviewer_assignment_status from latest_production_reviewer_governance), 'missing'),
      'productionSecondReviewStatus', coalesce((select production_second_review_status from latest_production_reviewer_governance), 'missing'),
      'productionAdjudicationStatus', coalesce((select production_adjudication_status from latest_production_reviewer_governance), 'missing'),
      'productionFollowupStatus', coalesce((select production_followup_status from latest_production_reviewer_governance), 'missing'),
      'productionExceptionStatus', coalesce((select production_exception_status from latest_production_reviewer_governance), 'missing'),
      'productionRollbackStatus', coalesce((select production_rollback_status from latest_production_reviewer_governance), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_production_reviewer_governance), 'missing'),
      'productionReviewWindowCount', coalesce((select production_review_window_count from latest_production_reviewer_governance), 0),
      'assignedProductionReviewerCount', coalesce((select assigned_production_reviewer_count from latest_production_reviewer_governance), 0),
      'secondReviewedProductionCount', coalesce((select second_reviewed_production_count from latest_production_reviewer_governance), 0),
      'adjudicatedProductionReviewCount', coalesce((select adjudicated_production_review_count from latest_production_reviewer_governance), 0),
      'followupClosedProductionCount', coalesce((select followup_closed_production_count from latest_production_reviewer_governance), 0),
      'exceptionClosedProductionCount', coalesce((select exception_closed_production_count from latest_production_reviewer_governance), 0),
      'rollbackReadyProductionCount', coalesce((select rollback_ready_production_count from latest_production_reviewer_governance), 0),
      'unresolvedProductionReviewerGovernanceCount', coalesce((select unresolved_production_reviewer_governance_count from latest_production_reviewer_governance), 0),
      'blockerCount', coalesce((select blocker_count from latest_production_reviewer_governance), 0),
      'lesionCount', coalesce((select lesion_count from latest_production_reviewer_governance), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_production_reviewer_governance), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_production_reviewer_governance), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_production_reviewer_governance), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_production_reviewer_governance), 0),
      'reviewedAt', (select reviewed_at from latest_production_reviewer_governance),
      'createdAt', (select created_at from latest_production_reviewer_governance),
      'updatedAt', (select updated_at from latest_production_reviewer_governance),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutProductionReviewerGovernance",
    jsonb_build_object(
      'id', coalesce((select id::text from latest_production_reviewer_evidence), ''),
      'clinicId', coalesce((select clinic_id::text from latest_production_reviewer_evidence), v.clinic_id::text),
      'patientId', coalesce((select patient_id::text from latest_production_reviewer_evidence), v.patient_id::text),
      'visitId', coalesce((select visit_id::text from latest_production_reviewer_evidence), v.id::text),
      'status', coalesce((select production_reviewer_evidence_status from latest_production_reviewer_evidence), 'not_started'),
      'reasons', coalesce((select production_reviewer_evidence_reasons from latest_production_reviewer_evidence), '[]'::jsonb),
      'productionDatasetEvidenceStatus', coalesce((select production_dataset_evidence_status from latest_production_reviewer_evidence), 'not_started'),
      'productionReviewerGovernanceStatus', coalesce((select production_reviewer_governance_status from latest_production_reviewer_evidence), 'not_started'),
      'protectedReviewerEvidenceStatus', coalesce((select protected_reviewer_evidence_status from latest_production_reviewer_evidence), 'not_started'),
      'protectedReviewerGovernanceStatus', coalesce((select protected_reviewer_governance_status from latest_production_reviewer_evidence), 'not_started'),
      'protectedReviewerValidationStatus', coalesce((select protected_reviewer_validation_status from latest_production_reviewer_evidence), 'not_started'),
      'longitudinalClinicalValidationStatus', coalesce((select longitudinal_clinical_validation_status from latest_production_reviewer_evidence), 'not_started'),
      'outcomeGovernanceStatus', coalesce((select outcome_governance_status from latest_production_reviewer_evidence), 'not_started'),
      'exceptionGovernanceStatus', coalesce((select exception_governance_status from latest_production_reviewer_evidence), 'not_started'),
      'observationGovernanceStatus', coalesce((select observation_governance_status from latest_production_reviewer_evidence), 'not_started'),
      'postValidationMonitoringStatus', coalesce((select post_validation_monitoring_status from latest_production_reviewer_evidence), 'not_started'),
      'clinicalValidationStatus', coalesce((select clinical_validation_status from latest_production_reviewer_evidence), 'not_started'),
      'incidentProcedureStatus', coalesce((select incident_procedure_status from latest_production_reviewer_evidence), 'not_started'),
      'monitoringStatus', coalesce((select monitoring_status from latest_production_reviewer_evidence), 'not_started'),
      'evidenceStatus', coalesce((select evidence_status from latest_production_reviewer_evidence), 'not_started'),
      'sopStatus', coalesce((select sop_status from latest_production_reviewer_evidence), 'not_started'),
      'validationStatus', coalesce((select dataset_validation_status from latest_production_reviewer_evidence), 'blocked'),
      'rolloutStatus', coalesce((select rollout_status from latest_production_reviewer_evidence), 'not_approved'),
      'productionReviewerAssignmentStatus', coalesce((select production_reviewer_assignment_status from latest_production_reviewer_evidence), 'missing'),
      'productionSecondReviewStatus', coalesce((select production_second_review_status from latest_production_reviewer_evidence), 'missing'),
      'productionAdjudicationStatus', coalesce((select production_adjudication_status from latest_production_reviewer_evidence), 'missing'),
      'productionFollowupStatus', coalesce((select production_followup_status from latest_production_reviewer_evidence), 'missing'),
      'productionExceptionStatus', coalesce((select production_exception_status from latest_production_reviewer_evidence), 'missing'),
      'productionRollbackStatus', coalesce((select production_rollback_status from latest_production_reviewer_evidence), 'missing'),
      'ownerSignoffStatus', coalesce((select owner_signoff_status from latest_production_reviewer_evidence), 'missing'),
      'productionReviewWindowCount', coalesce((select production_review_window_count from latest_production_reviewer_evidence), 0),
      'assignedProductionReviewerCount', coalesce((select assigned_production_reviewer_count from latest_production_reviewer_evidence), 0),
      'secondReviewedProductionCount', coalesce((select second_reviewed_production_count from latest_production_reviewer_evidence), 0),
      'adjudicatedProductionReviewCount', coalesce((select adjudicated_production_review_count from latest_production_reviewer_evidence), 0),
      'followupClosedProductionCount', coalesce((select followup_closed_production_count from latest_production_reviewer_evidence), 0),
      'exceptionClosedProductionCount', coalesce((select exception_closed_production_count from latest_production_reviewer_evidence), 0),
      'rollbackReadyProductionCount', coalesce((select rollback_ready_production_count from latest_production_reviewer_evidence), 0),
      'unresolvedProductionReviewerEvidenceCount', coalesce((select unresolved_production_reviewer_evidence_count from latest_production_reviewer_evidence), 0),
      'blockerCount', coalesce((select blocker_count from latest_production_reviewer_evidence), 0),
      'lesionCount', coalesce((select lesion_count from latest_production_reviewer_evidence), 0),
      'readyTimelineCount', coalesce((select ready_timeline_count from latest_production_reviewer_evidence), 0),
      'blockedTimelineCount', coalesce((select blocked_timeline_count from latest_production_reviewer_evidence), 0),
      'candidatePairCount', coalesce((select candidate_pair_count from latest_production_reviewer_evidence), 0),
      'reviewerWorkflowReadyCount', coalesce((select reviewer_workflow_ready_count from latest_production_reviewer_evidence), 0),
      'reviewedAt', (select reviewed_at from latest_production_reviewer_evidence),
      'createdAt', (select created_at from latest_production_reviewer_evidence),
      'updatedAt', (select updated_at from latest_production_reviewer_evidence),
      'patientDeliveryAllowed', false,
      'medicalMeasurementAllowed', false,
      'protectedFieldsExposed', false,
      'clinicalOutputGenerated', false
    ) as "timelineRolloutProductionReviewerEvidence",
    array_remove(array[
...
export function buildReviewVisitLongitudinalTimelineRolloutExceptionGovernanceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const exceptionGovernanceScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_exception_governance_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_exception_governance_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      exception_governance_status,
      exception_governance_reasons,
      observation_governance_status,
      post_validation_monitoring_status,
      clinical_validation_status,
      incident_procedure_status,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(exceptionGovernance.exceptionGovernanceStatus ?? "not_started")},
      ${sqlJsonb(exceptionGovernance.exceptionGovernanceReasons ?? [])},
      ${sqlLiteral(exceptionGovernance.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.monitoringStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.evidenceStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.sopStatus ?? "not_started")},
      ${sqlLiteral(exceptionGovernance.validationStatus ?? "blocked")},
      ${sqlLiteral(exceptionGovernance.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(exceptionGovernance.exceptionRegisterStatus ?? "missing")},
      ${sqlLiteral(exceptionGovernance.triageSlaStatus ?? "missing")},
      ${sqlLiteral(exceptionGovernance.resolutionEvidenceStatus ?? "missing")},
      ${sqlLiteral(exceptionGovernance.recurrenceReviewStatus ?? "missing")},
      ${sqlLiteral(exceptionGovernance.rollbackReadinessStatus ?? "missing")},
      ${sqlLiteral(exceptionGovernance.governanceArchiveStatus ?? "missing")},
      ${sqlLiteral(exceptionGovernance.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(exceptionGovernance.realDatasetTimelineCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.observedTimelineCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.governanceExceptionCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.resolvedGovernanceExceptionCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.unresolvedGovernanceExceptionCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.recurrenceSignalCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.unresolvedRecurrenceSignalCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.rollbackDrillCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.blockerCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.lesionCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.candidatePairCount ?? 0)},
      ${sqlNullableInteger(exceptionGovernance.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutExceptionGovernanceBoundary: "metadata_only",
        exceptionGovernanceBoundary: "aggregate_only",
        recurrenceReviewBoundary: "counts_only",
        rollbackReadinessBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      ...
      exception_governance_reasons = excluded.exception_governance_reasons,
      observation_governance_status = excluded.observation_governance_status,
      post_validation_monitoring_status = excluded.post_validation_monitoring_status,
      clinical_validation_status = excluded.clinical_validation_status,
      incident_procedure_status = excluded.incident_procedure_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      exception_register_status = excluded.exception_register_status,
      triage_sla_status = excluded.triage_sla_status,
      resolution_evidence_status = excluded.resolution_evidence_status,
      recurrence_review_status = excluded.recurrence_review_status,
      rollback_readiness_status = excluded.rollback_readiness_status,
      governance_archive_status = excluded.governance_archive_status,
      owner_signoff_status = excluded.owner_signoff_status,
      real_dataset_timeline_count = excluded.real_dataset_timeline_count,
      observed_timeline_count = excluded.observed_timeline_count,
      governance_exception_count = excluded.governance_exception_count,
      resolved_governance_exception_count = excluded.resolved_governance_exception_count,
      unresolved_governance_exception_count = excluded.unresolved_governance_exception_count,
      recurrence_signal_count = excluded.recurrence_signal_count,
      unresolved_recurrence_signal_count = excluded.unresolved_recurrence_signal_count,
      rollback_drill_count = excluded.rollback_drill_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_exception_governance_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${exceptionGovernanceScope}
    returning *
  )
  select
    x.id::text as "id",
    x.clinic_id::text as "clinicId",
    x.patient_id::text as "patientId",
    x.visit_id::text as "visitId",
    x.exception_governance_status as "status",
    x.exception_governance_reasons as "reasons",
    x.observation_governance_status as "observationGovernanceStatus",
    x.post_validation_monitoring_status as "postValidationMonitoringStatus",
    x.clinical_validation_status as "clinicalValidationStatus",
    x.incident_procedure_status as "incidentProcedureStatus",
    x.monitoring_status as "monitoringStatus",
    x.evidence_status as "evidenceStatus",
    x.sop_status as "sopStatus",
    x.dataset_validation_status as "validationStatus",
    x.rollout_status as "rolloutStatus",
    x.exception_register_status as "exceptionRegisterStatus",
    x.triage_sla_status as "triageSlaStatus",
    x.resolution_evidence_status as "resolutionEvidenceStatus",
    x.recurrence_review_status as "recurrenceReviewStatus",
    x.rollback_readiness_status as "rollbackReadinessStatus",
    x.governance_archive_status as "governanceArchiveStatus",
    x.owner_signoff_status as "ownerSignoffStatus",
    x.real_dataset_timeline_count as "realDatasetTimelineCount",
    x.observed_timeline_count as "observedTimelineCount",
    x.governance_exception_count as "governanceExceptionCount",
    x.resolved_governance_exception_count as "resolvedGovernanceExceptionCount",
    x.unresolved_governance_exception_count as "unresolvedGovernanceExceptionCount",
    x.recurrence_signal_count as "recurrenceSignalCount",
    x.unresolved_recurrence_signal_count as "unresolvedRecurrenceSignalCount",
    x.rollback_drill_count as "rollbackDrillCount",
    x.blocker_count as "blockerCount",
    x.lesion_count as "lesionCount",
    x.ready_timeline_count as "readyTimelineCount",
    x.blocked_timeline_count as "blockedTimelineCount",
    x.candidate_pair_count as "candidatePairCount",
    x.reviewer_workflow_ready_count as "reviewerWorkflowReadyCount",
    x.patient_delivery_allowed as "patientDeliveryAllowed",
    x.medical_measurement_allowed as "medicalMeasurementAllowed",
    x.protected_fields_exposed as "protectedFieldsExposed",
    x.clinical_output_generated as "clinicalOutputGenerated",
...
export function buildReviewVisitLongitudinalTimelineRolloutOutcomeGovernanceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const outcomeGovernanceScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_outcome_governance_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_outcome_governance_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      outcome_governance_status,
      outcome_governance_reasons,
      exception_governance_status,
      observation_governance_status,
      post_validation_monitoring_status,
      clinical_validation_status,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(outcomeGovernance.outcomeGovernanceStatus ?? "not_started")},
      ${sqlJsonb(outcomeGovernance.outcomeGovernanceReasons ?? [])},
      ${sqlLiteral(outcomeGovernance.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.monitoringStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.evidenceStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.sopStatus ?? "not_started")},
      ${sqlLiteral(outcomeGovernance.validationStatus ?? "blocked")},
      ${sqlLiteral(outcomeGovernance.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(outcomeGovernance.longitudinalWindowStatus ?? "missing")},
      ${sqlLiteral(outcomeGovernance.realDatasetCoverageStatus ?? "missing")},
      ${sqlLiteral(outcomeGovernance.reviewerOperationsValidationStatus ?? "missing")},
      ${sqlLiteral(outcomeGovernance.exceptionTrendReviewStatus ?? "missing")},
      ${sqlLiteral(outcomeGovernance.followupCadenceStatus ?? "missing")},
      ${sqlLiteral(outcomeGovernance.governanceCadenceStatus ?? "missing")},
      ${sqlLiteral(outcomeGovernance.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(outcomeGovernance.realDatasetTimelineCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.observedTimelineCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.followupWindowCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.completedFollowupCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.governanceExceptionCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.unresolvedGovernanceExceptionCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.recurrenceSignalCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.unresolvedRecurrenceSignalCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.governanceReviewCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.blockerCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.lesionCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.candidatePairCount ?? 0)},
      ${sqlNullableInteger(outcomeGovernance.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutOutcomeGovernanceBoundary: "metadata_only",
        outcomeGovernanceBoundary: "aggregate_only",
        longitudinalOutcomeGovernanceBoundary: "counts_only",
        followupCadenceBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      ...
      outcome_governance_reasons = excluded.outcome_governance_reasons,
      exception_governance_status = excluded.exception_governance_status,
      observation_governance_status = excluded.observation_governance_status,
      post_validation_monitoring_status = excluded.post_validation_monitoring_status,
      clinical_validation_status = excluded.clinical_validation_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      longitudinal_window_status = excluded.longitudinal_window_status,
      real_dataset_coverage_status = excluded.real_dataset_coverage_status,
      reviewer_operations_validation_status = excluded.reviewer_operations_validation_status,
      exception_trend_review_status = excluded.exception_trend_review_status,
      followup_cadence_status = excluded.followup_cadence_status,
      governance_cadence_status = excluded.governance_cadence_status,
      owner_signoff_status = excluded.owner_signoff_status,
      real_dataset_timeline_count = excluded.real_dataset_timeline_count,
      observed_timeline_count = excluded.observed_timeline_count,
      followup_window_count = excluded.followup_window_count,
      completed_followup_count = excluded.completed_followup_count,
      governance_exception_count = excluded.governance_exception_count,
      unresolved_governance_exception_count = excluded.unresolved_governance_exception_count,
      recurrence_signal_count = excluded.recurrence_signal_count,
      unresolved_recurrence_signal_count = excluded.unresolved_recurrence_signal_count,
      governance_review_count = excluded.governance_review_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_outcome_governance_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${outcomeGovernanceScope}
    returning *
  )
  select
    o.id::text as "id",
    o.clinic_id::text as "clinicId",
    o.patient_id::text as "patientId",
    o.visit_id::text as "visitId",
    o.outcome_governance_status as "status",
    o.outcome_governance_reasons as "reasons",
    o.exception_governance_status as "exceptionGovernanceStatus",
    o.observation_governance_status as "observationGovernanceStatus",
    o.post_validation_monitoring_status as "postValidationMonitoringStatus",
    o.clinical_validation_status as "clinicalValidationStatus",
    o.incident_procedure_status as "incidentProcedureStatus",
    o.monitoring_status as "monitoringStatus",
    o.evidence_status as "evidenceStatus",
    o.sop_status as "sopStatus",
    o.dataset_validation_status as "validationStatus",
    o.rollout_status as "rolloutStatus",
    o.longitudinal_window_status as "longitudinalWindowStatus",
    o.real_dataset_coverage_status as "realDatasetCoverageStatus",
    o.reviewer_operations_validation_status as "reviewerOperationsValidationStatus",
    o.exception_trend_review_status as "exceptionTrendReviewStatus",
    o.followup_cadence_status as "followupCadenceStatus",
    o.governance_cadence_status as "governanceCadenceStatus",
    o.owner_signoff_status as "ownerSignoffStatus",
    o.real_dataset_timeline_count as "realDatasetTimelineCount",
    o.observed_timeline_count as "observedTimelineCount",
    o.followup_window_count as "followupWindowCount",
    o.completed_followup_count as "completedFollowupCount",
    o.governance_exception_count as "governanceExceptionCount",
    o.unresolved_governance_exception_count as "unresolvedGovernanceExceptionCount",
    o.recurrence_signal_count as "recurrenceSignalCount",
    o.unresolved_recurrence_signal_count as "unresolvedRecurrenceSignalCount",
    o.governance_review_count as "governanceReviewCount",
    o.blocker_count as "blockerCount",
    o.lesion_count as "lesionCount",
    o.ready_timeline_count as "readyTimelineCount",
    o.blocked_timeline_count as "blockedTimelineCount",
    o.candidate_pair_count as "candidatePairCount",
    o.reviewer_workflow_ready_count as "reviewerWorkflowReadyCount",
    o.patient_delivery_allowed as "patientDeliveryAllowed",
    o.medical_measurement_allowed as "medicalMeasurementAllowed",
    o.protected_fields_exposed as "protectedFieldsExposed",
    o.clinical_output_generated as "clinicalOutputGenerated",
...
export function buildReviewVisitLongitudinalTimelineRolloutLongitudinalClinicalValidationSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_longitudinal_clinical_validation_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_longitudinal_clinical_validation_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(longitudinalClinicalValidation.longitudinalClinicalValidationStatus ?? "not_started")},
      ${sqlJsonb(longitudinalClinicalValidation.longitudinalClinicalValidationReasons ?? [])},
      ${sqlLiteral(longitudinalClinicalValidation.outcomeGovernanceStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.monitoringStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.evidenceStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.sopStatus ?? "not_started")},
      ${sqlLiteral(longitudinalClinicalValidation.validationStatus ?? "blocked")},
      ${sqlLiteral(longitudinalClinicalValidation.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(longitudinalClinicalValidation.outcomeWindowStatus ?? "missing")},
      ${sqlLiteral(longitudinalClinicalValidation.clinicianCoverageStatus ?? "missing")},
      ${sqlLiteral(longitudinalClinicalValidation.adjudicationStatus ?? "missing")},
      ${sqlLiteral(longitudinalClinicalValidation.consensusReviewStatus ?? "missing")},
      ${sqlLiteral(longitudinalClinicalValidation.followupValidationStatus ?? "missing")},
      ${sqlLiteral(longitudinalClinicalValidation.governanceCadenceStatus ?? "missing")},
      ${sqlLiteral(longitudinalClinicalValidation.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(longitudinalClinicalValidation.realOutcomeWindowCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.clinicallyValidatedWindowCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.adjudicatedWindowCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.followupValidatedWindowCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.consensusReviewCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.unresolvedConsensusCaseCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.governanceReviewCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.blockerCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.lesionCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.candidatePairCount ?? 0)},
      ${sqlNullableInteger(longitudinalClinicalValidation.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutLongitudinalClinicalValidationBoundary: "metadata_only",
        longitudinalClinicalValidationBoundary: "aggregate_only",
        adjudicationBoundary: "counts_only",
        consensusReviewBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      ...
      longitudinal_clinical_validation_reasons = excluded.longitudinal_clinical_validation_reasons,
      outcome_governance_status = excluded.outcome_governance_status,
      exception_governance_status = excluded.exception_governance_status,
      observation_governance_status = excluded.observation_governance_status,
      post_validation_monitoring_status = excluded.post_validation_monitoring_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      outcome_window_status = excluded.outcome_window_status,
      clinician_coverage_status = excluded.clinician_coverage_status,
      adjudication_status = excluded.adjudication_status,
      consensus_review_status = excluded.consensus_review_status,
      followup_validation_status = excluded.followup_validation_status,
      governance_cadence_status = excluded.governance_cadence_status,
      owner_signoff_status = excluded.owner_signoff_status,
      real_outcome_window_count = excluded.real_outcome_window_count,
      clinically_validated_window_count = excluded.clinically_validated_window_count,
      adjudicated_window_count = excluded.adjudicated_window_count,
      followup_validated_window_count = excluded.followup_validated_window_count,
      consensus_review_count = excluded.consensus_review_count,
      unresolved_consensus_case_count = excluded.unresolved_consensus_case_count,
      governance_review_count = excluded.governance_review_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_longitudinal_clinical_validation_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
  ...
  select
    ...
    l.longitudinal_clinical_validation_status as "status",
    l.longitudinal_clinical_validation_reasons as "reasons",
    l.outcome_governance_status as "outcomeGovernanceStatus",
    l.exception_governance_status as "exceptionGovernanceStatus",
    l.observation_governance_status as "observationGovernanceStatus",
    l.post_validation_monitoring_status as "postValidationMonitoringStatus",
    l.clinical_validation_status as "clinicalValidationStatus",
    l.incident_procedure_status as "incidentProcedureStatus",
    l.monitoring_status as "monitoringStatus",
    l.evidence_status as "evidenceStatus",
    l.sop_status as "sopStatus",
    l.dataset_validation_status as "validationStatus",
    l.rollout_status as "rolloutStatus",
    l.outcome_window_status as "outcomeWindowStatus",
    l.clinician_coverage_status as "clinicianCoverageStatus",
    l.adjudication_status as "adjudicationStatus",
    l.consensus_review_status as "consensusReviewStatus",
    l.followup_validation_status as "followupValidationStatus",
    l.governance_cadence_status as "governanceCadenceStatus",
    l.owner_signoff_status as "ownerSignoffStatus",
    l.real_outcome_window_count as "realOutcomeWindowCount",
    l.clinically_validated_window_count as "clinicallyValidatedWindowCount",
    l.adjudicated_window_count as "adjudicatedWindowCount",
    l.followup_validated_window_count as "followupValidatedWindowCount",
    l.consensus_review_count as "consensusReviewCount",
    l.unresolved_consensus_case_count as "unresolvedConsensusCaseCount",
    l.governance_review_count as "governanceReviewCount",
    l.blocker_count as "blockerCount",
    l.lesion_count as "lesionCount",
    l.ready_timeline_count as "readyTimelineCount",
    l.blocked_timeline_count as "blockedTimelineCount",
    l.candidate_pair_count as "candidatePairCount",
    l.reviewer_workflow_ready_count as "reviewerWorkflowReadyCount",
    l.patient_delivery_allowed as "patientDeliveryAllowed",
    l.medical_measurement_allowed as "medicalMeasurementAllowed",
    l.protected_fields_exposed as "protectedFieldsExposed",
    l.clinical_output_generated as "clinicalOutputGenerated",
...
export function buildReviewVisitLongitudinalTimelineRolloutProtectedReviewerGovernanceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_protected_reviewer_governance_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_protected_reviewer_governance_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      protected_reviewer_governance_status,
      protected_reviewer_governance_reasons,
      protected_reviewer_validation_status,
      longitudinal_clinical_validation_status,
      outcome_governance_status,
      exception_governance_status,
      ...
      rollback_ready_protected_count,
      archived_protected_review_count,
      unresolved_governance_review_count,
      blocker_count,
      lesion_count,
      ready_timeline_count,
      blocked_timeline_count,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(protectedReviewerGovernance.protectedReviewerGovernanceStatus ?? "not_started")},
      ${sqlJsonb(protectedReviewerGovernance.protectedReviewerGovernanceReasons ?? [])},
      ${sqlLiteral(protectedReviewerGovernance.protectedReviewerValidationStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.longitudinalClinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.outcomeGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.monitoringStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.evidenceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.sopStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerGovernance.validationStatus ?? "blocked")},
      ${sqlLiteral(protectedReviewerGovernance.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(protectedReviewerGovernance.reviewerMonitoringStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerGovernance.reviewerExceptionStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerGovernance.reviewerAdjudicationStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerGovernance.reviewerFollowupStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerGovernance.reviewerRollbackStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerGovernance.reviewerArchiveStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerGovernance.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(protectedReviewerGovernance.protectedReviewWindowCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.monitoredProtectedReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.escalatedProtectedReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.adjudicatedProtectedGovernanceCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.followupClosedProtectedCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.rollbackReadyProtectedCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.archivedProtectedReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.unresolvedGovernanceReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.blockerCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.lesionCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.candidatePairCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerGovernance.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutProtectedReviewerGovernanceBoundary: "metadata_only",
        protectedReviewerGovernanceBoundary: "aggregate_only",
        protectedReviewerOpsBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      reviewed_by_user_id = excluded.reviewed_by_user_id,
      protected_reviewer_governance_status = excluded.protected_reviewer_governance_status,
      protected_reviewer_governance_reasons = excluded.protected_reviewer_governance_reasons,
      protected_reviewer_validation_status = excluded.protected_reviewer_validation_status,
      longitudinal_clinical_validation_status = excluded.longitudinal_clinical_validation_status,
      outcome_governance_status = excluded.outcome_governance_status,
      exception_governance_status = excluded.exception_governance_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      reviewer_monitoring_status = excluded.reviewer_monitoring_status,
      reviewer_exception_status = excluded.reviewer_exception_status,
      reviewer_adjudication_status = excluded.reviewer_adjudication_status,
      reviewer_followup_status = excluded.reviewer_followup_status,
      reviewer_rollback_status = excluded.reviewer_rollback_status,
      reviewer_archive_status = excluded.reviewer_archive_status,
      owner_signoff_status = excluded.owner_signoff_status,
      protected_review_window_count = excluded.protected_review_window_count,
      monitored_protected_review_count = excluded.monitored_protected_review_count,
      escalated_protected_review_count = excluded.escalated_protected_review_count,
      adjudicated_protected_governance_count = excluded.adjudicated_protected_governance_count,
      followup_closed_protected_count = excluded.followup_closed_protected_count,
      rollback_ready_protected_count = excluded.rollback_ready_protected_count,
      archived_protected_review_count = excluded.archived_protected_review_count,
      unresolved_governance_review_count = excluded.unresolved_governance_review_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_protected_reviewer_governance_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${reviewScope}
    returning *
  ...
  select
    ...
    g.patient_id::text as "patientId",
    g.visit_id::text as "visitId",
    g.protected_reviewer_governance_status as "status",
    g.protected_reviewer_governance_reasons as "reasons",
    g.protected_reviewer_validation_status as "protectedReviewerValidationStatus",
    g.longitudinal_clinical_validation_status as "longitudinalClinicalValidationStatus",
    g.outcome_governance_status as "outcomeGovernanceStatus",
    g.exception_governance_status as "exceptionGovernanceStatus",
    g.observation_governance_status as "observationGovernanceStatus",
    g.post_validation_monitoring_status as "postValidationMonitoringStatus",
    g.clinical_validation_status as "clinicalValidationStatus",
    g.incident_procedure_status as "incidentProcedureStatus",
    g.monitoring_status as "monitoringStatus",
    ...
    g.dataset_validation_status as "validationStatus",
    g.rollout_status as "rolloutStatus",
    g.reviewer_monitoring_status as "reviewerMonitoringStatus",
    g.reviewer_exception_status as "reviewerExceptionStatus",
    g.reviewer_adjudication_status as "reviewerAdjudicationStatus",
    g.reviewer_followup_status as "reviewerFollowupStatus",
    g.reviewer_rollback_status as "reviewerRollbackStatus",
    g.reviewer_archive_status as "reviewerArchiveStatus",
    g.owner_signoff_status as "ownerSignoffStatus",
    g.protected_review_window_count as "protectedReviewWindowCount",
    g.monitored_protected_review_count as "monitoredProtectedReviewCount",
    g.escalated_protected_review_count as "escalatedProtectedReviewCount",
    g.adjudicated_protected_governance_count as "adjudicatedProtectedGovernanceCount",
    g.followup_closed_protected_count as "followupClosedProtectedCount",
    g.rollback_ready_protected_count as "rollbackReadyProtectedCount",
    g.archived_protected_review_count as "archivedProtectedReviewCount",
    g.unresolved_governance_review_count as "unresolvedGovernanceReviewCount",
    g.blocker_count as "blockerCount",
    g.lesion_count as "lesionCount",
    g.ready_timeline_count as "readyTimelineCount",
    g.blocked_timeline_count as "blockedTimelineCount",
...
export function buildReviewVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidenceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_production_reviewer_rollback_evidence_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_production_reviewer_rollback_evidence_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      production_reviewer_rollback_evidence_status,
      production_reviewer_rollback_evidence_reasons,
      production_dataset_evidence_status,
      rollback_drill_status,
      rollback_owner_status,
      rollback_window_status,
      rollback_exception_status,
      rollback_archive_status,
      owner_signoff_status,
      production_review_window_count,
      rollback_drill_production_count,
      rollback_ready_production_count,
      rollback_exception_count,
      unresolved_rollback_evidence_count,
      blocker_count,
      lesion_count,
      ready_timeline_count,
      blocked_timeline_count,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(productionReviewerRollbackEvidence.productionReviewerRollbackEvidenceStatus ?? "not_started")},
      ${sqlJsonb(productionReviewerRollbackEvidence.productionReviewerRollbackEvidenceReasons ?? [])},
      ${sqlLiteral(productionReviewerRollbackEvidence.productionDatasetEvidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerRollbackEvidence.rollbackDrillStatus ?? "missing")},
      ${sqlLiteral(productionReviewerRollbackEvidence.rollbackOwnerStatus ?? "missing")},
      ${sqlLiteral(productionReviewerRollbackEvidence.rollbackWindowStatus ?? "missing")},
      ${sqlLiteral(productionReviewerRollbackEvidence.rollbackExceptionStatus ?? "missing")},
      ${sqlLiteral(productionReviewerRollbackEvidence.rollbackArchiveStatus ?? "missing")},
      ${sqlLiteral(productionReviewerRollbackEvidence.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.productionReviewWindowCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.rollbackDrillProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.rollbackReadyProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.rollbackExceptionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.unresolvedRollbackEvidenceCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.blockerCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.lesionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.candidatePairCount ?? 0)},
      ${sqlNullableInteger(productionReviewerRollbackEvidence.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutProductionReviewerRollbackEvidenceBoundary: "metadata_only",
        productionReviewerRollbackEvidenceBoundary: "aggregate_only",
        productionReviewerOpsBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      reviewed_by_user_id = excluded.reviewed_by_user_id,
      production_reviewer_rollback_evidence_status = excluded.production_reviewer_rollback_evidence_status,
      production_reviewer_rollback_evidence_reasons = excluded.production_reviewer_rollback_evidence_reasons,
      production_dataset_evidence_status = excluded.production_dataset_evidence_status,
      rollback_drill_status = excluded.rollback_drill_status,
      rollback_owner_status = excluded.rollback_owner_status,
      rollback_window_status = excluded.rollback_window_status,
      rollback_exception_status = excluded.rollback_exception_status,
      rollback_archive_status = excluded.rollback_archive_status,
      owner_signoff_status = excluded.owner_signoff_status,
      production_review_window_count = excluded.production_review_window_count,
      rollback_drill_production_count = excluded.rollback_drill_production_count,
      rollback_ready_production_count = excluded.rollback_ready_production_count,
      rollback_exception_count = excluded.rollback_exception_count,
      unresolved_rollback_evidence_count = excluded.unresolved_rollback_evidence_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_production_reviewer_rollback_evidence_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${reviewScope}
    returning *
  ...
  select
    ...
    r.production_reviewer_rollback_evidence_status as "status",
    r.production_reviewer_rollback_evidence_reasons as "reasons",
    r.production_dataset_evidence_status as "productionDatasetEvidenceStatus",
    r.rollback_drill_status as "rollbackDrillStatus",
    r.rollback_owner_status as "rollbackOwnerStatus",
    r.rollback_window_status as "rollbackWindowStatus",
    r.rollback_exception_status as "rollbackExceptionStatus",
    r.rollback_archive_status as "rollbackArchiveStatus",
    r.owner_signoff_status as "ownerSignoffStatus",
    r.production_review_window_count as "productionReviewWindowCount",
    r.rollback_drill_production_count as "rollbackDrillProductionCount",
    r.rollback_ready_production_count as "rollbackReadyProductionCount",
    r.rollback_exception_count as "rollbackExceptionCount",
    r.unresolved_rollback_evidence_count as "unresolvedRollbackEvidenceCount",
    r.blocker_count as "blockerCount",
...
export function buildReviewVisitLongitudinalTimelineRolloutProductionReviewerGovernanceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_production_reviewer_governance_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_production_reviewer_governance_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      production_reviewer_governance_status,
      production_reviewer_governance_reasons,
      production_dataset_evidence_status,
      protected_reviewer_evidence_status,
      protected_reviewer_governance_status,
      protected_reviewer_validation_status,
      longitudinal_clinical_validation_status,
      outcome_governance_status,
      ...
      dataset_validation_status,
      rollout_status,
      production_reviewer_assignment_status,
      production_second_review_status,
      production_adjudication_status,
      production_followup_status,
      production_exception_status,
      production_rollback_status,
      owner_signoff_status,
      production_review_window_count,
      assigned_production_reviewer_count,
      second_reviewed_production_count,
      adjudicated_production_review_count,
      followup_closed_production_count,
      exception_closed_production_count,
      rollback_ready_production_count,
      unresolved_production_reviewer_governance_count,
      blocker_count,
      lesion_count,
      ready_timeline_count,
      blocked_timeline_count,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(productionReviewerGovernance.productionReviewerGovernanceStatus ?? "not_started")},
      ${sqlJsonb(productionReviewerGovernance.productionReviewerGovernanceReasons ?? [])},
      ${sqlLiteral(productionReviewerGovernance.productionDatasetEvidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.protectedReviewerEvidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.protectedReviewerGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.protectedReviewerValidationStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.longitudinalClinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.outcomeGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.monitoringStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.evidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.sopStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerGovernance.validationStatus ?? "blocked")},
      ${sqlLiteral(productionReviewerGovernance.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(productionReviewerGovernance.productionReviewerAssignmentStatus ?? "missing")},
      ${sqlLiteral(productionReviewerGovernance.productionSecondReviewStatus ?? "missing")},
      ${sqlLiteral(productionReviewerGovernance.productionAdjudicationStatus ?? "missing")},
      ${sqlLiteral(productionReviewerGovernance.productionFollowupStatus ?? "missing")},
      ${sqlLiteral(productionReviewerGovernance.productionExceptionStatus ?? "missing")},
      ${sqlLiteral(productionReviewerGovernance.productionRollbackStatus ?? "missing")},
      ${sqlLiteral(productionReviewerGovernance.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(productionReviewerGovernance.productionReviewWindowCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.assignedProductionReviewerCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.secondReviewedProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.adjudicatedProductionReviewCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.followupClosedProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.exceptionClosedProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.rollbackReadyProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.unresolvedProductionReviewerGovernanceCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.blockerCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.lesionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.candidatePairCount ?? 0)},
      ${sqlNullableInteger(productionReviewerGovernance.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutProductionReviewerGovernanceBoundary: "metadata_only",
        productionReviewerGovernanceBoundary: "aggregate_only",
        productionReviewerOpsBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
    ...
    set
      reviewed_by_user_id = excluded.reviewed_by_user_id,
      production_reviewer_governance_status = excluded.production_reviewer_governance_status,
      production_reviewer_governance_reasons = excluded.production_reviewer_governance_reasons,
      production_dataset_evidence_status = excluded.production_dataset_evidence_status,
      protected_reviewer_evidence_status = excluded.protected_reviewer_evidence_status,
      protected_reviewer_governance_status = excluded.protected_reviewer_governance_status,
      protected_reviewer_validation_status = excluded.protected_reviewer_validation_status,
      longitudinal_clinical_validation_status = excluded.longitudinal_clinical_validation_status,
      outcome_governance_status = excluded.outcome_governance_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      production_reviewer_assignment_status = excluded.production_reviewer_assignment_status,
      production_second_review_status = excluded.production_second_review_status,
      production_adjudication_status = excluded.production_adjudication_status,
      production_followup_status = excluded.production_followup_status,
      production_exception_status = excluded.production_exception_status,
      production_rollback_status = excluded.production_rollback_status,
      owner_signoff_status = excluded.owner_signoff_status,
      production_review_window_count = excluded.production_review_window_count,
      assigned_production_reviewer_count = excluded.assigned_production_reviewer_count,
      second_reviewed_production_count = excluded.second_reviewed_production_count,
      adjudicated_production_review_count = excluded.adjudicated_production_review_count,
      followup_closed_production_count = excluded.followup_closed_production_count,
      exception_closed_production_count = excluded.exception_closed_production_count,
      rollback_ready_production_count = excluded.rollback_ready_production_count,
      unresolved_production_reviewer_governance_count = excluded.unresolved_production_reviewer_governance_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_production_reviewer_governance_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${reviewScope}
    returning *
  ...
  select
    ...
    g.patient_id::text as "patientId",
    g.visit_id::text as "visitId",
    g.production_reviewer_governance_status as "status",
    g.production_reviewer_governance_reasons as "reasons",
    g.production_dataset_evidence_status as "productionDatasetEvidenceStatus",
    g.protected_reviewer_evidence_status as "protectedReviewerEvidenceStatus",
    g.protected_reviewer_governance_status as "protectedReviewerGovernanceStatus",
    g.protected_reviewer_validation_status as "protectedReviewerValidationStatus",
    g.longitudinal_clinical_validation_status as "longitudinalClinicalValidationStatus",
    g.outcome_governance_status as "outcomeGovernanceStatus",
    g.exception_governance_status as "exceptionGovernanceStatus",
    ...
    g.dataset_validation_status as "validationStatus",
    g.rollout_status as "rolloutStatus",
    g.production_reviewer_assignment_status as "productionReviewerAssignmentStatus",
    g.production_second_review_status as "productionSecondReviewStatus",
    g.production_adjudication_status as "productionAdjudicationStatus",
    g.production_followup_status as "productionFollowupStatus",
    g.production_exception_status as "productionExceptionStatus",
    g.production_rollback_status as "productionRollbackStatus",
    g.owner_signoff_status as "ownerSignoffStatus",
    g.production_review_window_count as "productionReviewWindowCount",
    g.assigned_production_reviewer_count as "assignedProductionReviewerCount",
    g.second_reviewed_production_count as "secondReviewedProductionCount",
    g.adjudicated_production_review_count as "adjudicatedProductionReviewCount",
    g.followup_closed_production_count as "followupClosedProductionCount",
    g.exception_closed_production_count as "exceptionClosedProductionCount",
    g.rollback_ready_production_count as "rollbackReadyProductionCount",
    g.unresolved_production_reviewer_governance_count as "unresolvedProductionReviewerGovernanceCount",
    g.blocker_count as "blockerCount",
    g.lesion_count as "lesionCount",
    g.ready_timeline_count as "readyTimelineCount",
    g.blocked_timeline_count as "blockedTimelineCount",
...
export function buildReviewVisitLongitudinalTimelineRolloutProductionReviewerEvidenceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_production_reviewer_evidence_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_production_reviewer_evidence_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      production_reviewer_evidence_status,
      production_reviewer_evidence_reasons,
      production_dataset_evidence_status,
      production_reviewer_governance_status,
      protected_reviewer_evidence_status,
      protected_reviewer_governance_status,
      ...
      exception_closed_production_count,
      rollback_ready_production_count,
      unresolved_production_reviewer_evidence_count,
      blocker_count,
      lesion_count,
      ready_timeline_count,
      blocked_timeline_count,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(productionReviewerEvidence.productionReviewerEvidenceStatus ?? "not_started")},
      ${sqlJsonb(productionReviewerEvidence.productionReviewerEvidenceReasons ?? [])},
      ${sqlLiteral(productionReviewerEvidence.productionDatasetEvidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.productionReviewerGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.protectedReviewerEvidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.protectedReviewerGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.protectedReviewerValidationStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.longitudinalClinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.outcomeGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.monitoringStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.evidenceStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.sopStatus ?? "not_started")},
      ${sqlLiteral(productionReviewerEvidence.validationStatus ?? "blocked")},
      ${sqlLiteral(productionReviewerEvidence.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(productionReviewerEvidence.productionReviewerAssignmentStatus ?? "missing")},
      ${sqlLiteral(productionReviewerEvidence.productionSecondReviewStatus ?? "missing")},
      ${sqlLiteral(productionReviewerEvidence.productionAdjudicationStatus ?? "missing")},
      ${sqlLiteral(productionReviewerEvidence.productionFollowupStatus ?? "missing")},
      ${sqlLiteral(productionReviewerEvidence.productionExceptionStatus ?? "missing")},
      ${sqlLiteral(productionReviewerEvidence.productionRollbackStatus ?? "missing")},
      ${sqlLiteral(productionReviewerEvidence.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(productionReviewerEvidence.productionReviewWindowCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.assignedProductionReviewerCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.secondReviewedProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.adjudicatedProductionReviewCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.followupClosedProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.exceptionClosedProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.rollbackReadyProductionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.unresolvedProductionReviewerEvidenceCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.blockerCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.lesionCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.candidatePairCount ?? 0)},
      ${sqlNullableInteger(productionReviewerEvidence.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutProductionReviewerEvidenceBoundary: "metadata_only",
        productionReviewerEvidenceBoundary: "aggregate_only",
        productionReviewerOpsBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
    ...
    set
      reviewed_by_user_id = excluded.reviewed_by_user_id,
      production_reviewer_evidence_status = excluded.production_reviewer_evidence_status,
      production_reviewer_evidence_reasons = excluded.production_reviewer_evidence_reasons,
      production_dataset_evidence_status = excluded.production_dataset_evidence_status,
      production_reviewer_governance_status = excluded.production_reviewer_governance_status,
      protected_reviewer_evidence_status = excluded.protected_reviewer_evidence_status,
      protected_reviewer_governance_status = excluded.protected_reviewer_governance_status,
      ...
      exception_closed_production_count = excluded.exception_closed_production_count,
      rollback_ready_production_count = excluded.rollback_ready_production_count,
      unresolved_production_reviewer_evidence_count = excluded.unresolved_production_reviewer_evidence_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_production_reviewer_evidence_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${reviewScope}
    returning *
  ...
  select
    ...
    g.patient_id::text as "patientId",
    g.visit_id::text as "visitId",
    g.production_reviewer_evidence_status as "status",
    g.production_reviewer_evidence_reasons as "reasons",
    g.production_dataset_evidence_status as "productionDatasetEvidenceStatus",
    g.production_reviewer_governance_status as "productionReviewerGovernanceStatus",
    g.protected_reviewer_evidence_status as "protectedReviewerEvidenceStatus",
    g.protected_reviewer_governance_status as "protectedReviewerGovernanceStatus",
    g.protected_reviewer_validation_status as "protectedReviewerValidationStatus",
    g.longitudinal_clinical_validation_status as "longitudinalClinicalValidationStatus",
    ...
    g.exception_closed_production_count as "exceptionClosedProductionCount",
    g.rollback_ready_production_count as "rollbackReadyProductionCount",
    g.unresolved_production_reviewer_evidence_count as "unresolvedProductionReviewerEvidenceCount",
    g.blocker_count as "blockerCount",
    g.lesion_count as "lesionCount",
    g.ready_timeline_count as "readyTimelineCount",
    g.blocked_timeline_count as "blockedTimelineCount",
...
export function buildReviewVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_protected_reviewer_evidence_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_protected_reviewer_evidence_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      protected_reviewer_evidence_status,
      protected_reviewer_evidence_reasons,
      protected_reviewer_governance_status,
      protected_reviewer_validation_status,
      longitudinal_clinical_validation_status,
      outcome_governance_status,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(protectedReviewerEvidence.protectedReviewerEvidenceStatus ?? "not_started")},
      ${sqlJsonb(protectedReviewerEvidence.protectedReviewerEvidenceReasons ?? [])},
      ${sqlLiteral(protectedReviewerEvidence.protectedReviewerGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.protectedReviewerValidationStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.longitudinalClinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.outcomeGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.monitoringStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.evidenceStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.sopStatus ?? "not_started")},
      ${sqlLiteral(protectedReviewerEvidence.validationStatus ?? "blocked")},
      ${sqlLiteral(protectedReviewerEvidence.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(protectedReviewerEvidence.reviewerMonitoringEvidenceStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerEvidence.reviewerExceptionEvidenceStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerEvidence.reviewerAdjudicationEvidenceStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerEvidence.reviewerFollowupEvidenceStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerEvidence.reviewerRollbackEvidenceStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerEvidence.reviewerArchiveEvidenceStatus ?? "missing")},
      ${sqlLiteral(protectedReviewerEvidence.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(protectedReviewerEvidence.protectedReviewWindowCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.monitoredProtectedReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.sampledProtectedReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.adjudicatedProtectedEvidenceCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.followupClosedProtectedCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.rollbackDrillProtectedCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.archivedProtectedReviewCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.unresolvedProtectedEvidenceCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.blockerCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.lesionCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.candidatePairCount ?? 0)},
      ${sqlNullableInteger(protectedReviewerEvidence.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutProtectedReviewerEvidenceBoundary: "metadata_only",
        protectedReviewerEvidenceBoundary: "aggregate_only",
        protectedReviewerEvidenceOpsBoundary: "counts_only",
        protectedReviewerMonitoringBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      reviewed_by_user_id = excluded.reviewed_by_user_id,
      protected_reviewer_evidence_status = excluded.protected_reviewer_evidence_status,
      protected_reviewer_evidence_reasons = excluded.protected_reviewer_evidence_reasons,
      protected_reviewer_governance_status = excluded.protected_reviewer_governance_status,
      protected_reviewer_validation_status = excluded.protected_reviewer_validation_status,
      longitudinal_clinical_validation_status = excluded.longitudinal_clinical_validation_status,
      outcome_governance_status = excluded.outcome_governance_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      reviewer_monitoring_evidence_status = excluded.reviewer_monitoring_evidence_status,
      reviewer_exception_evidence_status = excluded.reviewer_exception_evidence_status,
      reviewer_adjudication_evidence_status = excluded.reviewer_adjudication_evidence_status,
      reviewer_followup_evidence_status = excluded.reviewer_followup_evidence_status,
      reviewer_rollback_evidence_status = excluded.reviewer_rollback_evidence_status,
      reviewer_archive_evidence_status = excluded.reviewer_archive_evidence_status,
      owner_signoff_status = excluded.owner_signoff_status,
      protected_review_window_count = excluded.protected_review_window_count,
      monitored_protected_review_count = excluded.monitored_protected_review_count,
      sampled_protected_review_count = excluded.sampled_protected_review_count,
      adjudicated_protected_evidence_count = excluded.adjudicated_protected_evidence_count,
      followup_closed_protected_count = excluded.followup_closed_protected_count,
      rollback_drill_protected_count = excluded.rollback_drill_protected_count,
      archived_protected_review_count = excluded.archived_protected_review_count,
      unresolved_protected_evidence_count = excluded.unresolved_protected_evidence_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_protected_reviewer_evidence_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${reviewScope}
    returning *
  ...
  select
    ...
    e.patient_id::text as "patientId",
    e.visit_id::text as "visitId",
    e.protected_reviewer_evidence_status as "status",
    e.protected_reviewer_evidence_reasons as "reasons",
    e.protected_reviewer_governance_status as "protectedReviewerGovernanceStatus",
    e.protected_reviewer_validation_status as "protectedReviewerValidationStatus",
    e.longitudinal_clinical_validation_status as "longitudinalClinicalValidationStatus",
    e.outcome_governance_status as "outcomeGovernanceStatus",
    e.exception_governance_status as "exceptionGovernanceStatus",
    e.observation_governance_status as "observationGovernanceStatus",
    e.post_validation_monitoring_status as "postValidationMonitoringStatus",
    e.clinical_validation_status as "clinicalValidationStatus",
    e.incident_procedure_status as "incidentProcedureStatus",
    e.monitoring_status as "monitoringStatus",
    e.evidence_status as "evidenceStatus",
    e.sop_status as "sopStatus",
    e.dataset_validation_status as "validationStatus",
    e.rollout_status as "rolloutStatus",
    e.reviewer_monitoring_evidence_status as "reviewerMonitoringEvidenceStatus",
    e.reviewer_exception_evidence_status as "reviewerExceptionEvidenceStatus",
    e.reviewer_adjudication_evidence_status as "reviewerAdjudicationEvidenceStatus",
    e.reviewer_followup_evidence_status as "reviewerFollowupEvidenceStatus",
    e.reviewer_rollback_evidence_status as "reviewerRollbackEvidenceStatus",
    e.reviewer_archive_evidence_status as "reviewerArchiveEvidenceStatus",
    e.owner_signoff_status as "ownerSignoffStatus",
    e.protected_review_window_count as "protectedReviewWindowCount",
    e.monitored_protected_review_count as "monitoredProtectedReviewCount",
    e.sampled_protected_review_count as "sampledProtectedReviewCount",
    e.adjudicated_protected_evidence_count as "adjudicatedProtectedEvidenceCount",
    e.followup_closed_protected_count as "followupClosedProtectedCount",
    e.rollback_drill_protected_count as "rollbackDrillProtectedCount",
    e.archived_protected_review_count as "archivedProtectedReviewCount",
    e.unresolved_protected_evidence_count as "unresolvedProtectedEvidenceCount",
    e.blocker_count as "blockerCount",
    e.lesion_count as "lesionCount",
    e.ready_timeline_count as "readyTimelineCount",
    e.blocked_timeline_count as "blockedTimelineCount",
    e.candidate_pair_count as "candidatePairCount",
...
export function buildReviewVisitLongitudinalTimelineRolloutProductionDatasetEvidenceSql({
  visitId,
  patientId,
  clinicId,
  doctorUserId = null,
  ...
  const visitScope = clinicScopeWhere({ alias: "v", clinicIds, allClinics });
  const reviewScope = clinicScopeWhere({
    alias: "visit_longitudinal_timeline_rollout_production_dataset_evidence_reviews",
    clinicIds,
    allClinics,
  });
  return `
...
from (
  ...
  upserted as (
    insert into visit_longitudinal_timeline_rollout_production_dataset_evidence_reviews (
      clinic_id,
      patient_id,
      visit_id,
      reviewed_by_user_id,
      production_dataset_evidence_status,
      production_dataset_evidence_reasons,
      protected_reviewer_evidence_status,
      protected_reviewer_governance_status,
      protected_reviewer_validation_status,
      longitudinal_clinical_validation_status,
      ...
      dataset_validation_status,
      rollout_status,
      real_clinic_window_status,
      dataset_sampling_status,
      longitudinal_followup_status,
      protected_reviewer_linkage_status,
      outcome_observation_status,
      incident_linkage_status,
      owner_signoff_status,
      real_clinic_window_count,
      monitored_clinic_operation_count,
      sampled_clinic_operation_count,
      longitudinal_followup_count,
      protected_reviewer_linked_count,
      observed_outcome_count,
      incident_linked_count,
      unresolved_production_dataset_evidence_count,
      blocker_count,
      lesion_count,
      ready_timeline_count,
      blocked_timeline_count,
    ...
    select
      ...
      v.id,
      ${sqlNullableUuid(doctorUserId)},
      ${sqlLiteral(productionDatasetEvidence.productionDatasetEvidenceStatus ?? "not_started")},
      ${sqlJsonb(productionDatasetEvidence.productionDatasetEvidenceReasons ?? [])},
      ${sqlLiteral(productionDatasetEvidence.protectedReviewerEvidenceStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.protectedReviewerGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.protectedReviewerValidationStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.longitudinalClinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.outcomeGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.exceptionGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.observationGovernanceStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.postValidationMonitoringStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.clinicalValidationStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.incidentProcedureStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.monitoringStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.evidenceStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.sopStatus ?? "not_started")},
      ${sqlLiteral(productionDatasetEvidence.validationStatus ?? "blocked")},
      ${sqlLiteral(productionDatasetEvidence.rolloutStatus ?? "not_approved")},
      ${sqlLiteral(productionDatasetEvidence.realClinicWindowStatus ?? "missing")},
      ${sqlLiteral(productionDatasetEvidence.datasetSamplingStatus ?? "missing")},
      ${sqlLiteral(productionDatasetEvidence.longitudinalFollowupStatus ?? "missing")},
      ${sqlLiteral(productionDatasetEvidence.protectedReviewerLinkageStatus ?? "missing")},
      ${sqlLiteral(productionDatasetEvidence.outcomeObservationStatus ?? "missing")},
      ${sqlLiteral(productionDatasetEvidence.incidentLinkageStatus ?? "missing")},
      ${sqlLiteral(productionDatasetEvidence.ownerSignoffStatus ?? "missing")},
      ${sqlNullableInteger(productionDatasetEvidence.realClinicWindowCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.monitoredClinicOperationCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.sampledClinicOperationCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.longitudinalFollowupCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.protectedReviewerLinkedCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.observedOutcomeCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.incidentLinkedCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.unresolvedProductionDatasetEvidenceCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.blockerCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.lesionCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.readyTimelineCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.blockedTimelineCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.candidatePairCount ?? 0)},
      ${sqlNullableInteger(productionDatasetEvidence.reviewerWorkflowReadyCount ?? 0)},
      false,
      false,
      false,
      false,
      ${sqlJsonb({
        brainstormTask: "SD-MF-025/026/028",
        timelineRolloutProductionDatasetEvidenceBoundary: "metadata_only",
        productionDatasetEvidenceBoundary: "aggregate_only",
        clinicOperationEvidenceBoundary: "counts_only",
        longitudinalEvidenceBoundary: "counts_only",
        patientDeliveryAllowed: false,
        medicalMeasurementAllowed: false,
        protectedFieldsExposed: false,
        clinicalOutputGenerated: false,
    ...
    set
      reviewed_by_user_id = excluded.reviewed_by_user_id,
      production_dataset_evidence_status = excluded.production_dataset_evidence_status,
      production_dataset_evidence_reasons = excluded.production_dataset_evidence_reasons,
      protected_reviewer_evidence_status = excluded.protected_reviewer_evidence_status,
      protected_reviewer_governance_status = excluded.protected_reviewer_governance_status,
      protected_reviewer_validation_status = excluded.protected_reviewer_validation_status,
      longitudinal_clinical_validation_status = excluded.longitudinal_clinical_validation_status,
      ...
      dataset_validation_status = excluded.dataset_validation_status,
      rollout_status = excluded.rollout_status,
      real_clinic_window_status = excluded.real_clinic_window_status,
      dataset_sampling_status = excluded.dataset_sampling_status,
      longitudinal_followup_status = excluded.longitudinal_followup_status,
      protected_reviewer_linkage_status = excluded.protected_reviewer_linkage_status,
      outcome_observation_status = excluded.outcome_observation_status,
      incident_linkage_status = excluded.incident_linkage_status,
      owner_signoff_status = excluded.owner_signoff_status,
      real_clinic_window_count = excluded.real_clinic_window_count,
      monitored_clinic_operation_count = excluded.monitored_clinic_operation_count,
      sampled_clinic_operation_count = excluded.sampled_clinic_operation_count,
      longitudinal_followup_count = excluded.longitudinal_followup_count,
      protected_reviewer_linked_count = excluded.protected_reviewer_linked_count,
      observed_outcome_count = excluded.observed_outcome_count,
      incident_linked_count = excluded.incident_linked_count,
      unresolved_production_dataset_evidence_count = excluded.unresolved_production_dataset_evidence_count,
      blocker_count = excluded.blocker_count,
      lesion_count = excluded.lesion_count,
      ready_timeline_count = excluded.ready_timeline_count,
      blocked_timeline_count = excluded.blocked_timeline_count,
      ...
      protected_fields_exposed = false,
      clinical_output_generated = false,
      metadata_json = visit_longitudinal_timeline_rollout_production_dataset_evidence_reviews.metadata_json || excluded.metadata_json,
      reviewed_at = now(),
      updated_at = now()
    where true ${reviewScope}
    returning *
  ...
  select
    ...
    p.patient_id::text as "patientId",
    p.visit_id::text as "visitId",
    p.production_dataset_evidence_status as "status",
    p.production_dataset_evidence_reasons as "reasons",
    p.protected_reviewer_evidence_status as "protectedReviewerEvidenceStatus",
    p.protected_reviewer_governance_status as "protectedReviewerGovernanceStatus",
    p.protected_reviewer_validation_status as "protectedReviewerValidationStatus",
    p.longitudinal_clinical_validation_status as "longitudinalClinicalValidationStatus",
    p.outcome_governance_status as "outcomeGovernanceStatus",
    p.exception_governance_status as "exceptionGovernanceStatus",
    p.observation_governance_status as "observationGovernanceStatus",
    ...
    p.dataset_validation_status as "validationStatus",
    p.rollout_status as "rolloutStatus",
    p.real_clinic_window_status as "realClinicWindowStatus",
    p.dataset_sampling_status as "datasetSamplingStatus",
    p.longitudinal_followup_status as "longitudinalFollowupStatus",
    p.protected_reviewer_linkage_status as "protectedReviewerLinkageStatus",
    p.outcome_observation_status as "outcomeObservationStatus",
    p.incident_linkage_status as "incidentLinkageStatus",
    p.owner_signoff_status as "ownerSignoffStatus",
    p.real_clinic_window_count as "realClinicWindowCount",
    p.monitored_clinic_operation_count as "monitoredClinicOperationCount",
    p.sampled_clinic_operation_count as "sampledClinicOperationCount",
    p.longitudinal_followup_count as "longitudinalFollowupCount",
    p.protected_reviewer_linked_count as "protectedReviewerLinkedCount",
    p.observed_outcome_count as "observedOutcomeCount",
    p.incident_linked_count as "incidentLinkedCount",
    p.unresolved_production_dataset_evidence_count as "unresolvedProductionDatasetEvidenceCount",
    p.blocker_count as "blockerCount",
    p.lesion_count as "lesionCount",
    p.ready_timeline_count as "readyTimelineCount",
    p.blocked_timeline_count as "blockedTimelineCount",
...
const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_EXCEPTION_GOVERNANCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_exception_governance",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_OUTCOME_GOVERNANCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_outcome_governance",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_LONGITUDINAL_CLINICAL_VALIDATION_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
...
const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PROTECTED_REVIEWER_GOVERNANCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_protected_reviewer_governance",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PROTECTED_REVIEWER_EVIDENCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_protected_reviewer_evidence",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_DATASET_EVIDENCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_production_dataset_evidence",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_REVIEWER_ROLLBACK_EVIDENCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_production_reviewer_rollback_evidence",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_REVIEWER_GOVERNANCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
  "ready_for_production_reviewer_governance",
]);

const VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_REVIEWER_EVIDENCE_STATUS_VALUES = new Set([
  "not_started",
  "in_review",
...
function normalizeVisitLongitudinalTimelineRolloutExceptionGovernanceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_EXCEPTION_GOVERNANCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}

function normalizeVisitLongitudinalTimelineRolloutOutcomeGovernanceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_OUTCOME_GOVERNANCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}
...
function normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernanceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PROTECTED_REVIEWER_GOVERNANCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}

function normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PROTECTED_REVIEWER_EVIDENCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}

function normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidenceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_DATASET_EVIDENCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}

function normalizeVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidenceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_REVIEWER_ROLLBACK_EVIDENCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}

function normalizeVisitLongitudinalTimelineRolloutProductionReviewerGovernanceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_REVIEWER_GOVERNANCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}

function normalizeVisitLongitudinalTimelineRolloutProductionReviewerEvidenceStatus(value) {
  const status = String(value ?? "not_started");
  return VISIT_LONGITUDINAL_TIMELINE_ROLLOUT_PRODUCTION_REVIEWER_EVIDENCE_STATUS_VALUES.has(status)
    ? status
    : "not_started";
}
...
function normalizeVisitLongitudinalTimelineRolloutExceptionGovernance(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutExceptionGovernanceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    exceptionRegisterStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.exceptionRegisterStatus,
    ),
    triageSlaStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.triageSlaStatus),
    resolutionEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.resolutionEvidenceStatus,
    ),
    recurrenceReviewStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.recurrenceReviewStatus,
    ),
    rollbackReadinessStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.rollbackReadinessStatus,
    ),
    governanceArchiveStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.governanceArchiveStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    realDatasetTimelineCount: numberOrZero(source.realDatasetTimelineCount),
    observedTimelineCount: numberOrZero(source.observedTimelineCount),
    governanceExceptionCount: numberOrZero(source.governanceExceptionCount),
    resolvedGovernanceExceptionCount: numberOrZero(source.resolvedGovernanceExceptionCount),
    unresolvedGovernanceExceptionCount: numberOrZero(source.unresolvedGovernanceExceptionCount),
    recurrenceSignalCount: numberOrZero(source.recurrenceSignalCount),
    unresolvedRecurrenceSignalCount: numberOrZero(source.unresolvedRecurrenceSignalCount),
    rollbackDrillCount: numberOrZero(source.rollbackDrillCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutOutcomeGovernance(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutOutcomeGovernanceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    longitudinalWindowStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.longitudinalWindowStatus,
    ),
    realDatasetCoverageStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.realDatasetCoverageStatus,
    ),
    reviewerOperationsValidationStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerOperationsValidationStatus,
    ),
    exceptionTrendReviewStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.exceptionTrendReviewStatus,
    ),
    followupCadenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.followupCadenceStatus,
    ),
    governanceCadenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.governanceCadenceStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    realDatasetTimelineCount: numberOrZero(source.realDatasetTimelineCount),
    observedTimelineCount: numberOrZero(source.observedTimelineCount),
    followupWindowCount: numberOrZero(source.followupWindowCount),
    completedFollowupCount: numberOrZero(source.completedFollowupCount),
    governanceExceptionCount: numberOrZero(source.governanceExceptionCount),
    unresolvedGovernanceExceptionCount: numberOrZero(source.unresolvedGovernanceExceptionCount),
    recurrenceSignalCount: numberOrZero(source.recurrenceSignalCount),
    unresolvedRecurrenceSignalCount: numberOrZero(source.unresolvedRecurrenceSignalCount),
    governanceReviewCount: numberOrZero(source.governanceReviewCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutLongitudinalClinicalValidation(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutLongitudinalClinicalValidationStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    outcomeWindowStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.outcomeWindowStatus),
    clinicianCoverageStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.clinicianCoverageStatus,
    ),
    adjudicationStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.adjudicationStatus),
    consensusReviewStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.consensusReviewStatus,
    ),
    followupValidationStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.followupValidationStatus,
    ),
    governanceCadenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.governanceCadenceStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    realOutcomeWindowCount: numberOrZero(source.realOutcomeWindowCount),
    clinicallyValidatedWindowCount: numberOrZero(source.clinicallyValidatedWindowCount),
    adjudicatedWindowCount: numberOrZero(source.adjudicatedWindowCount),
    followupValidatedWindowCount: numberOrZero(source.followupValidatedWindowCount),
    consensusReviewCount: numberOrZero(source.consensusReviewCount),
    unresolvedConsensusCaseCount: numberOrZero(source.unresolvedConsensusCaseCount),
    governanceReviewCount: numberOrZero(source.governanceReviewCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernance(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernanceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    protectedReviewerValidationStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerValidationStatus(
        source.protectedReviewerValidationStatus,
      ),
    longitudinalClinicalValidationStatus:
      normalizeVisitLongitudinalTimelineRolloutLongitudinalClinicalValidationStatus(
        source.longitudinalClinicalValidationStatus,
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    reviewerMonitoringStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerMonitoringStatus,
    ),
    reviewerExceptionStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerExceptionStatus,
    ),
    reviewerAdjudicationStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerAdjudicationStatus,
    ),
    reviewerFollowupStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerFollowupStatus,
    ),
    reviewerRollbackStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerRollbackStatus,
    ),
    reviewerArchiveStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerArchiveStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    protectedReviewWindowCount: numberOrZero(source.protectedReviewWindowCount),
    monitoredProtectedReviewCount: numberOrZero(source.monitoredProtectedReviewCount),
    escalatedProtectedReviewCount: numberOrZero(source.escalatedProtectedReviewCount),
    adjudicatedProtectedGovernanceCount: numberOrZero(source.adjudicatedProtectedGovernanceCount),
    followupClosedProtectedCount: numberOrZero(source.followupClosedProtectedCount),
    rollbackReadyProtectedCount: numberOrZero(source.rollbackReadyProtectedCount),
    archivedProtectedReviewCount: numberOrZero(source.archivedProtectedReviewCount),
    unresolvedGovernanceReviewCount: numberOrZero(source.unresolvedGovernanceReviewCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutProductionReviewerGovernance(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutProductionReviewerGovernanceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    productionDatasetEvidenceStatus:
      normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidenceStatus(
        source.productionDatasetEvidenceStatus,
      ),
    protectedReviewerEvidenceStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceStatus(
        source.protectedReviewerEvidenceStatus,
      ),
    protectedReviewerGovernanceStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernanceStatus(
        source.protectedReviewerGovernanceStatus,
      ),
    protectedReviewerValidationStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerValidationStatus(
        source.protectedReviewerValidationStatus,
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    productionReviewerAssignmentStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.productionReviewerAssignmentStatus,
    ),
    productionSecondReviewStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.productionSecondReviewStatus,
    ),
    productionAdjudicationStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.productionAdjudicationStatus,
    ),
    productionFollowupStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.productionFollowupStatus,
    ),
    productionExceptionStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.productionExceptionStatus,
    ),
    productionRollbackStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.productionRollbackStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    productionReviewWindowCount: numberOrZero(source.productionReviewWindowCount),
    assignedProductionReviewerCount: numberOrZero(source.assignedProductionReviewerCount),
    secondReviewedProductionCount: numberOrZero(source.secondReviewedProductionCount),
    adjudicatedProductionReviewCount: numberOrZero(source.adjudicatedProductionReviewCount),
    followupClosedProductionCount: numberOrZero(source.followupClosedProductionCount),
    exceptionClosedProductionCount: numberOrZero(source.exceptionClosedProductionCount),
    rollbackReadyProductionCount: numberOrZero(source.rollbackReadyProductionCount),
    unresolvedProductionReviewerGovernanceCount: numberOrZero(source.unresolvedProductionReviewerGovernanceCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutProductionReviewerEvidence(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutProductionReviewerEvidenceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    productionDatasetEvidenceStatus:
      normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidenceStatus(
        source.productionDatasetEvidenceStatus,
    ...
    productionReviewerGovernanceStatus:
      normalizeVisitLongitudinalTimelineRolloutProductionReviewerGovernanceStatus(
        source.productionReviewerGovernanceStatus,
      ),
    protectedReviewerEvidenceStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceStatus(
        source.protectedReviewerEvidenceStatus,
    ...
    exceptionClosedProductionCount: numberOrZero(source.exceptionClosedProductionCount),
    rollbackReadyProductionCount: numberOrZero(source.rollbackReadyProductionCount),
    unresolvedProductionReviewerEvidenceCount: numberOrZero(source.unresolvedProductionReviewerEvidenceCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidence(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    protectedReviewerGovernanceStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernanceStatus(
        source.protectedReviewerGovernanceStatus,
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    reviewerMonitoringEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerMonitoringEvidenceStatus,
    ),
    reviewerExceptionEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerExceptionEvidenceStatus,
    ),
    reviewerAdjudicationEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerAdjudicationEvidenceStatus,
    ),
    reviewerFollowupEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerFollowupEvidenceStatus,
    ),
    reviewerRollbackEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerRollbackEvidenceStatus,
    ),
    reviewerArchiveEvidenceStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.reviewerArchiveEvidenceStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    protectedReviewWindowCount: numberOrZero(source.protectedReviewWindowCount),
    monitoredProtectedReviewCount: numberOrZero(source.monitoredProtectedReviewCount),
    sampledProtectedReviewCount: numberOrZero(source.sampledProtectedReviewCount),
    adjudicatedProtectedEvidenceCount: numberOrZero(source.adjudicatedProtectedEvidenceCount),
    followupClosedProtectedCount: numberOrZero(source.followupClosedProtectedCount),
    rollbackDrillProtectedCount: numberOrZero(source.rollbackDrillProtectedCount),
    archivedProtectedReviewCount: numberOrZero(source.archivedProtectedReviewCount),
    unresolvedProtectedEvidenceCount: numberOrZero(source.unresolvedProtectedEvidenceCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidence(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidenceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    protectedReviewerEvidenceStatus:
      normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceStatus(
        source.protectedReviewerEvidenceStatus,
    ...
    validationStatus: normalizeVisitLongitudinalDatasetValidationStatus(source.validationStatus),
    rolloutStatus: normalizeVisitLongitudinalTimelineRolloutStatus(source.rolloutStatus),
    realClinicWindowStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.realClinicWindowStatus,
    ),
    datasetSamplingStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.datasetSamplingStatus,
    ),
    longitudinalFollowupStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.longitudinalFollowupStatus,
    ),
    protectedReviewerLinkageStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.protectedReviewerLinkageStatus,
    ),
    outcomeObservationStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.outcomeObservationStatus,
    ),
    incidentLinkageStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.incidentLinkageStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    realClinicWindowCount: numberOrZero(source.realClinicWindowCount),
    monitoredClinicOperationCount: numberOrZero(source.monitoredClinicOperationCount),
    sampledClinicOperationCount: numberOrZero(source.sampledClinicOperationCount),
    longitudinalFollowupCount: numberOrZero(source.longitudinalFollowupCount),
    protectedReviewerLinkedCount: numberOrZero(source.protectedReviewerLinkedCount),
    observedOutcomeCount: numberOrZero(source.observedOutcomeCount),
    incidentLinkedCount: numberOrZero(source.incidentLinkedCount),
    unresolvedProductionDatasetEvidenceCount: numberOrZero(source.unresolvedProductionDatasetEvidenceCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidence(row) {
  const source = parseJsonObject(row);
  return {
    id: source.id ? String(source.id) : null,
    clinicId: source.clinicId ? String(source.clinicId) : null,
    patientId: source.patientId ? String(source.patientId) : null,
    visitId: source.visitId ? String(source.visitId) : null,
    status: normalizeVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidenceStatus(source.status),
    reasons: parseJsonArray(source.reasons),
    productionDatasetEvidenceStatus:
      normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidenceStatus(
        source.productionDatasetEvidenceStatus,
      ),
    rollbackDrillStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.rollbackDrillStatus,
    ),
    rollbackOwnerStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.rollbackOwnerStatus,
    ),
    rollbackWindowStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.rollbackWindowStatus,
    ),
    rollbackExceptionStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.rollbackExceptionStatus,
    ),
    rollbackArchiveStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(
      source.rollbackArchiveStatus,
    ),
    ownerSignoffStatus: normalizeVisitLongitudinalTimelineRolloutSopChecklistStatus(source.ownerSignoffStatus),
    productionReviewWindowCount: numberOrZero(source.productionReviewWindowCount),
    rollbackDrillProductionCount: numberOrZero(source.rollbackDrillProductionCount),
    rollbackReadyProductionCount: numberOrZero(source.rollbackReadyProductionCount),
    rollbackExceptionCount: numberOrZero(source.rollbackExceptionCount),
    unresolvedRollbackEvidenceCount: numberOrZero(source.unresolvedRollbackEvidenceCount),
    blockerCount: numberOrZero(source.blockerCount),
    lesionCount: numberOrZero(source.lesionCount),
    readyTimelineCount: numberOrZero(source.readyTimelineCount),
    blockedTimelineCount: numberOrZero(source.blockedTimelineCount),
...
function normalizeVisitLongitudinalDatasetValidation(row) {
  return {
    ...
    timelineRolloutExceptionGovernance: normalizeVisitLongitudinalTimelineRolloutExceptionGovernance(
      row.timelineRolloutExceptionGovernance,
    ),
    timelineRolloutOutcomeGovernance: normalizeVisitLongitudinalTimelineRolloutOutcomeGovernance(
      row.timelineRolloutOutcomeGovernance,
    ),
    ...
    timelineRolloutProtectedReviewerGovernance: normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernance(
      row.timelineRolloutProtectedReviewerGovernance,
    ),
    timelineRolloutProtectedReviewerEvidence: normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidence(
      row.timelineRolloutProtectedReviewerEvidence,
    ),
    timelineRolloutProductionDatasetEvidence: normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidence(
      row.timelineRolloutProductionDatasetEvidence,
    ),
    timelineRolloutProductionReviewerRollbackEvidence:
      normalizeVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidence(
        row.timelineRolloutProductionReviewerRollbackEvidence,
      ),
    timelineRolloutProductionReviewerGovernance: normalizeVisitLongitudinalTimelineRolloutProductionReviewerGovernance(
      row.timelineRolloutProductionReviewerGovernance,
    ),
    timelineRolloutProductionReviewerEvidence: normalizeVisitLongitudinalTimelineRolloutProductionReviewerEvidence(
      row.timelineRolloutProductionReviewerEvidence,
    ),
    nextActions: normalizeLongitudinalQaActions(row.nextActions),
    boundaries: {
      patientDeliveryAllowed: false,
...
export function createClinicalWorkspaceRepository(dbClient) {
  return {
    ...
    async reviewVisitLongitudinalTimelineRolloutExceptionGovernance(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutExceptionGovernanceSql(params),
        normalizeVisitLongitudinalTimelineRolloutExceptionGovernance,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutOutcomeGovernance(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutOutcomeGovernanceSql(params),
        normalizeVisitLongitudinalTimelineRolloutOutcomeGovernance,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutLongitudinalClinicalValidation(params) {
      return queryOne(
        dbClient,
    ...
    async reviewVisitLongitudinalTimelineRolloutProtectedReviewerGovernance(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutProtectedReviewerGovernanceSql(params),
        normalizeVisitLongitudinalTimelineRolloutProtectedReviewerGovernance,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutProtectedReviewerEvidence(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutProtectedReviewerEvidenceSql(params),
        normalizeVisitLongitudinalTimelineRolloutProtectedReviewerEvidence,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutProductionDatasetEvidence(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutProductionDatasetEvidenceSql(params),
        normalizeVisitLongitudinalTimelineRolloutProductionDatasetEvidence,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidence(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidenceSql(params),
        normalizeVisitLongitudinalTimelineRolloutProductionReviewerRollbackEvidence,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutProductionReviewerGovernance(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutProductionReviewerGovernanceSql(params),
        normalizeVisitLongitudinalTimelineRolloutProductionReviewerGovernance,
      );
    },
    async reviewVisitLongitudinalTimelineRolloutProductionReviewerEvidence(params) {
      return queryOne(
        dbClient,
        buildReviewVisitLongitudinalTimelineRolloutProductionReviewerEvidenceSql(params),
        normalizeVisitLongitudinalTimelineRolloutProductionReviewerEvidence,
      );
    },
