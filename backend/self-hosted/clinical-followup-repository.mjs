...
export function normalizeClinicalFollowUp(row = {}) {
  ...
  return {
    ...
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState ?? row.stage41_archive_readiness_closure_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote ?? row.stage41_archive_readiness_closure_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosedAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosedAt ?? row.stage41_archive_readiness_closure_closed_at),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState ?? row.stage42_archive_closure_receipt_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote ?? row.stage42_archive_closure_receipt_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceivedAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceivedAt ?? row.stage42_archive_closure_receipt_received_at),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState ?? row.stage43_archive_receipt_handoff_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote ?? row.stage43_archive_receipt_handoff_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandedOffAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandedOffAt ?? row.stage43_archive_receipt_handed_off_at),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState ?? row.stage44_archive_handoff_receipt_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote ?? row.stage44_archive_handoff_receipt_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceivedAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceivedAt ?? row.stage44_archive_handoff_received_at),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState ?? row.stage45_archive_handoff_receipt_reconciliation_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote ?? row.stage45_archive_handoff_receipt_reconciliation_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciledAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciledAt ?? row.stage45_archive_handoff_receipt_reconciled_at),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState ?? row.stage46_archive_handoff_receipt_reconciliation_closure_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote ?? row.stage46_archive_handoff_receipt_reconciliation_closure_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosedAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosedAt ?? row.stage46_archive_handoff_receipt_recon_closed_at),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState ?? row.stage47_archive_handoff_recon_closure_receipt_state) || "not_started",
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote ?? row.stage47_archive_handoff_recon_closure_receipt_note),
    sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceivedAt: cleanText(row.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceivedAt ?? row.stage47_archive_handoff_recon_closure_receipt_at),
...
function followUpSelect({ patientSafe = false } = {}) {
  ...
  return `
    ...
    coalesce(f.stage41_archive_readiness_closure_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState",
    f.stage41_archive_readiness_closure_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote",
    f.stage41_archive_readiness_closure_closed_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosedAt",
    coalesce(f.stage42_archive_closure_receipt_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState",
    f.stage42_archive_closure_receipt_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote",
    f.stage42_archive_closure_receipt_received_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceivedAt",
    coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState",
    f.stage43_archive_receipt_handoff_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote",
    f.stage43_archive_receipt_handed_off_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandedOffAt",
    coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState",
    f.stage44_archive_handoff_receipt_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote",
    f.stage44_archive_handoff_received_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceivedAt",
    coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState",
    f.stage45_archive_handoff_receipt_reconciliation_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote",
    f.stage45_archive_handoff_receipt_reconciled_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciledAt",
    coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState",
    f.stage46_archive_handoff_receipt_reconciliation_closure_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote",
    f.stage46_archive_handoff_receipt_recon_closed_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosedAt",
    coalesce(f.stage47_archive_handoff_recon_closure_receipt_state, 'not_started') as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState",
    f.stage47_archive_handoff_recon_closure_receipt_note as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote",
    f.stage47_archive_handoff_recon_closure_receipt_at as "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceivedAt",
...
export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReady = [
    "(",
    "coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') in ('ready', 'archived')",
    "and coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage37_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled'",
    "and coalesce(f.stage36_archive_handoff_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage35_archive_receipt_handoff_state, 'not_started') = 'handed_off'",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReady})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReady",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReady} and coalesce(f.stage41_archive_readiness_closure_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosure",
      count(*) filter (where coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures",
      count(*) filter (where coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closure_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureExceptions",
      count(*) filter (where coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNeedsRework",
      count(*) filter (where coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') = 'archived')::int as "archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliations",
      count(*) filter (where coalesce(f.stage37_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled')::int as "reconciledArchiveClosureReceiptHandoffReceipts",
      ...
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage41_archive_readiness_closure_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureEvents"
    from scoped_followups f
  `;
}

export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureSql({
  followUpId,
  actorUserId,
  changes,
  allClinics = false,
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState)
    : "p.stage41_archive_readiness_closure_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote)
    : "p.stage41_archive_readiness_closure_note";
  const closureState = ["ready", "closed", "closure_exception", "needs_rework"].includes(
    changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState,
  );
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage41_archive_readiness_closure_state = ${nextState},
          stage41_archive_readiness_closure_note = ${nextNote},
          stage41_archive_readiness_closure_closed_by_user_id = ${closureState ? sqlUuid(actorUserId) : "p.stage41_archive_readiness_closure_closed_by_user_id"},
          stage41_archive_readiness_closure_closed_at = ${closureState ? "now()" : "p.stage41_archive_readiness_closure_closed_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
        p.stage41_archive_readiness_closure_state as previous_stage41_archive_readiness_closure_state,
        p.stage41_archive_readiness_closure_note as previous_stage41_archive_readiness_closure_note,
        p.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state as previous_stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state,
        p.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state as previous_stage39_archive_handoff_receipt_reconciliation_closure_receipt_state,
        p.stage38_archive_handoff_receipt_reconciliation_closure_state as previous_stage38_archive_handoff_receipt_reconciliation_closure_state,
        p.stage37_archive_handoff_receipt_reconciliation_state as previous_stage37_archive_handoff_receipt_reconciliation_state,
      ...
      insert into clinical_follow_up_stage41_archive_readiness_closure_events (
        follow_up_id,
        clinic_id,
        actor_user_id,
        event_type,
        previous_state,
        next_state,
        archive_readiness_closure_state,
        stage40_archive_readiness_state,
        stage39_closure_receipt_state,
        stage38_reconciliation_closure_state,
        stage37_reconciliation_state,
        stage36_handoff_receipt_state,
        stage35_receipt_handoff_state,
      ...
      select
        ...
        u.clinic_id,
        ${sqlUuid(actorUserId)},
        'sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState', coalesce(previous_stage41_archive_readiness_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote', previous_stage41_archive_readiness_closure_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessState', coalesce(previous_stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptState', coalesce(previous_stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(previous_stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationState', coalesce(previous_stage37_archive_handoff_receipt_reconciliation_state, 'not_started'),
        ...
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState', coalesce(u.stage41_archive_readiness_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNote', u.stage41_archive_readiness_closure_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessState', coalesce(u.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptState', coalesce(u.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(u.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationState', coalesce(u.stage37_archive_handoff_receipt_reconciliation_state, 'not_started'),
        ...
        coalesce(u.stage41_archive_readiness_closure_state, 'not_started'),
        coalesce(u.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
        coalesce(u.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started'),
        coalesce(u.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
        coalesce(u.stage37_archive_handoff_receipt_reconciliation_state, 'not_started'),
...
export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptReady = [
    "(",
    "coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') in ('ready', 'archived')",
    "and coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage37_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled'",
    "and coalesce(f.stage36_archive_handoff_receipt_state, 'not_started') = 'received'",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptReady})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptReady",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptReady} and coalesce(f.stage42_archive_closure_receipt_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipt",
      count(*) filter (where coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts",
      count(*) filter (where coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'receipt_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptExceptions",
      count(*) filter (where coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNeedsRework",
      count(*) filter (where coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') = 'archived')::int as "archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliations",
      count(*) filter (where coalesce(f.stage37_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled')::int as "reconciledArchiveClosureReceiptHandoffReceipts",
      ...
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage42_archive_closure_receipt_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptEvents"
    from scoped_followups f
  `;
}


export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReady = [
    "(",
    "coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') in ('ready', 'archived')",
    "and coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage37_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled'",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReady})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReady",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReady} and coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoff",
      count(*) filter (where coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handed_off')::int as "handedOffArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffs",
      count(*) filter (where coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handoff_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffExceptions",
      count(*) filter (where coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNeedsRework",
      count(*) filter (where coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts",
      count(*) filter (where coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures",
      count(*) filter (where coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') = 'archived')::int as "archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      ...
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage43_archive_receipt_handoff_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffEvents"
    from scoped_followups f
  `;
}

export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReady = [
    "(",
    "coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled'",
    "and coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handed_off'",
    "and coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') in ('ready', 'archived')",
    "and coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed'",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReady})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReady",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReady} and coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosure",
      count(*) filter (where coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosures",
      count(*) filter (where coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closure_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureExceptions",
      count(*) filter (where coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNeedsRework",
      count(*) filter (where coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled')::int as "reconciledArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts",
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage46_handoff_receipt_recon_closure_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureEvents"
    from scoped_followups f
  `;
}

export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationReady = [
    "(",
    "coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handed_off'",
    "and coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') in ('ready', 'archived')",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationReady})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationReady",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationReady} and coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliation",
      count(*) filter (where coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled')::int as "reconciledArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts",
      count(*) filter (where coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciliation_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationExceptions",
      count(*) filter (where coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNeedsRework",
      count(*) filter (where coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts",
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage45_handoff_receipt_recon_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationEvents"
    from scoped_followups f
  `;
}

export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReady = [
    "(",
    "coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handed_off'",
    "and coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') in ('ready', 'archived')",
    "and coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received'",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReady})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReady",
      count(*) filter (where ${archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReady} and coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipt",
      count(*) filter (where coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts",
      count(*) filter (where coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handed_off')::int as "handedOffArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffs",
      count(*) filter (where coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'receipt_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptExceptions",
      count(*) filter (where coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNeedsRework",
      count(*) filter (where coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts",
      count(*) filter (where coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures",
      count(*) filter (where coalesce(f.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started') = 'archived')::int as "archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      ...
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage44_archive_handoff_receipt_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptEvents"
    from scoped_followups f
  `;
}

export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffSql({
  followUpId,
  actorUserId,
  changes,
  allClinics = false,
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState)
    : "p.stage43_archive_receipt_handoff_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote)
    : "p.stage43_archive_receipt_handoff_note";
  const handoffState = ["ready", "handed_off", "handoff_exception", "needs_rework"].includes(
    changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState,
  );
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage43_archive_receipt_handoff_state = ${nextState},
          stage43_archive_receipt_handoff_note = ${nextNote},
          stage43_archive_receipt_handed_off_by_user_id = ${handoffState ? sqlUuid(actorUserId) : "p.stage43_archive_receipt_handed_off_by_user_id"},
          stage43_archive_receipt_handed_off_at = ${handoffState ? "now()" : "p.stage43_archive_receipt_handed_off_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
        p.stage43_archive_receipt_handoff_state as previous_stage43_archive_receipt_handoff_state,
        p.stage43_archive_receipt_handoff_note as previous_stage43_archive_receipt_handoff_note,
        p.stage42_archive_closure_receipt_state as previous_stage42_archive_closure_receipt_state,
        p.stage42_archive_closure_receipt_note as previous_stage42_archive_closure_receipt_note,
        p.stage41_archive_readiness_closure_state as previous_stage41_archive_readiness_closure_state,
        p.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state as previous_stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state,
        p.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state as previous_stage39_archive_handoff_receipt_reconciliation_closure_receipt_state,
        p.stage38_archive_handoff_receipt_reconciliation_closure_state as previous_stage38_archive_handoff_receipt_reconciliation_closure_state,
      ...
      insert into clinical_follow_up_stage43_archive_receipt_handoff_events (
        follow_up_id,
        clinic_id,
        actor_user_id,
        event_type,
        ...
        next_state,
        archive_receipt_handoff_state,
        stage42_archive_closure_receipt_state,
        stage41_archive_closure_state,
        stage40_archive_readiness_state,
        stage39_closure_receipt_state,
        stage38_reconciliation_closure_state,
        stage37_reconciliation_state,
      ...
      select
        ...
        u.clinic_id,
        ${sqlUuid(actorUserId)},
        'sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState', coalesce(previous_stage43_archive_receipt_handoff_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote', previous_stage43_archive_receipt_handoff_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState', coalesce(previous_stage42_archive_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote', previous_stage42_archive_closure_receipt_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState', coalesce(previous_stage41_archive_readiness_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessState', coalesce(previous_stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptState', coalesce(previous_stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(previous_stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
        ...
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffState', coalesce(u.stage43_archive_receipt_handoff_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNote', u.stage43_archive_receipt_handoff_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState', coalesce(u.stage42_archive_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote', u.stage42_archive_closure_receipt_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState', coalesce(u.stage41_archive_readiness_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessState', coalesce(u.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptState', coalesce(u.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(u.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
        ...
        coalesce(u.stage43_archive_receipt_handoff_state, 'not_started'),
        coalesce(u.stage42_archive_closure_receipt_state, 'not_started'),
        coalesce(u.stage41_archive_readiness_closure_state, 'not_started'),
        coalesce(u.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
        coalesce(u.stage39_archive_handoff_receipt_reconciliation_closure_receipt_state, 'not_started'),
        coalesce(u.stage38_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
...
export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureSql({
  followUpId,
  actorUserId,
  changes,
  allClinics = false,
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState)
    : "p.stage46_archive_handoff_receipt_reconciliation_closure_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote)
    : "p.stage46_archive_handoff_receipt_reconciliation_closure_note";
  const closureState = ["ready", "closed", "closure_exception", "needs_rework"].includes(
    changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState,
  );
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage46_archive_handoff_receipt_reconciliation_closure_state = ${nextState},
          stage46_archive_handoff_receipt_reconciliation_closure_note = ${nextNote},
          stage46_archive_handoff_receipt_recon_closed_by_user_id = ${closureState ? sqlUuid(actorUserId) : "p.stage46_archive_handoff_receipt_recon_closed_by_user_id"},
          stage46_archive_handoff_receipt_recon_closed_at = ${closureState ? "now()" : "p.stage46_archive_handoff_receipt_recon_closed_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
        p.stage46_archive_handoff_receipt_reconciliation_closure_state as previous_stage46_archive_handoff_receipt_reconciliation_closure_state,
        p.stage46_archive_handoff_receipt_reconciliation_closure_note as previous_stage46_archive_handoff_receipt_reconciliation_closure_note,
        p.stage45_archive_handoff_receipt_reconciliation_state as previous_stage45_archive_handoff_receipt_reconciliation_state,
        p.stage45_archive_handoff_receipt_reconciliation_note as previous_stage45_archive_handoff_receipt_reconciliation_note,
        p.stage44_archive_handoff_receipt_state as previous_stage44_archive_handoff_receipt_state,
        p.stage43_archive_receipt_handoff_state as previous_stage43_archive_receipt_handoff_state,
        p.stage42_archive_closure_receipt_state as previous_stage42_archive_closure_receipt_state,
        p.stage41_archive_readiness_closure_state as previous_stage41_archive_readiness_closure_state,
        p.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state as previous_stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state,
      ...
      insert into clinical_follow_up_stage46_handoff_receipt_recon_closure_events (
        follow_up_id, clinic_id, actor_user_id, event_type, previous_state, next_state,
        archive_handoff_receipt_reconciliation_closure_state, stage45_archive_handoff_receipt_reconciliation_state,
        stage44_archive_handoff_receipt_state, stage43_archive_receipt_handoff_state,
        stage42_archive_closure_receipt_state, stage41_archive_closure_state,
        stage40_archive_readiness_state, stage39_closure_receipt_state,
        stage38_reconciliation_closure_state, stage37_reconciliation_state,
        stage36_handoff_receipt_state, stage35_receipt_handoff_state,
        stage34_archive_closure_receipt_state, note
      )
      select
        u.id, u.clinic_id, ${sqlUuid(actorUserId)},
        'clinical_follow_up.sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt_reconciliation_closure.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(previous_stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote', previous_stage46_archive_handoff_receipt_reconciliation_closure_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState', coalesce(previous_stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote', previous_stage45_archive_handoff_receipt_reconciliation_note
        ),
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(u.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote', u.stage46_archive_handoff_receipt_reconciliation_closure_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState', coalesce(u.stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote', u.stage45_archive_handoff_receipt_reconciliation_note
        ),
        coalesce(u.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
        coalesce(u.stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
        coalesce(u.stage44_archive_handoff_receipt_state, 'not_started'),
        coalesce(u.stage43_archive_receipt_handoff_state, 'not_started'),
        coalesce(u.stage42_archive_closure_receipt_state, 'not_started'),
        coalesce(u.stage41_archive_readiness_closure_state, 'not_started'),
        coalesce(u.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state, 'not_started'),
...
export function buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptSummarySql({
  allClinics = false,
  clinicIds = [],
} = {}) {
  const scopedFollowUps = clinicScopeWhere("f", { allClinics, clinicIds });
  const ready = [
    "(",
    "coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed'",
    "and coalesce(f.stage45_archive_handoff_receipt_reconciliation_state, 'not_started') = 'reconciled'",
    "and coalesce(f.stage44_archive_handoff_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage43_archive_receipt_handoff_state, 'not_started') = 'handed_off'",
    "and coalesce(f.stage42_archive_closure_receipt_state, 'not_started') = 'received'",
    "and coalesce(f.stage41_archive_readiness_closure_state, 'not_started') = 'closed'",
  ...
  return `
    ...
    select
      count(*)::int as "totalFollowUps",
      count(*) filter (where ${ready})::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptReady",
      count(*) filter (where ${ready} and coalesce(f.stage47_archive_handoff_recon_closure_receipt_state, 'not_started') in ('not_started', 'ready', 'needs_rework'))::int as "needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipt",
      count(*) filter (where coalesce(f.stage47_archive_handoff_recon_closure_receipt_state, 'not_started') = 'received')::int as "receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipts",
      count(*) filter (where coalesce(f.stage47_archive_handoff_recon_closure_receipt_state, 'not_started') = 'receipt_exception')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptExceptions",
      count(*) filter (where coalesce(f.stage47_archive_handoff_recon_closure_receipt_state, 'not_started') = 'needs_rework')::int as "archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNeedsRework",
      count(*) filter (where coalesce(f.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started') = 'closed')::int as "closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosures",
      count(*) filter (where exists (
        select 1
        from clinical_follow_up_stage47_recon_closure_receipt_events e
        where e.follow_up_id = f.id
      ))::int as "localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptEvents"
    from scoped_followups f
  `;
}

export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptSql({
  followUpId,
  actorUserId,
  changes,
  allClinics = false,
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState)
    : "p.stage47_archive_handoff_recon_closure_receipt_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote)
    : "p.stage47_archive_handoff_recon_closure_receipt_note";
  const receiptState = ["ready", "received", "receipt_exception", "needs_rework"].includes(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState);
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage47_archive_handoff_recon_closure_receipt_state = ${nextState},
          stage47_archive_handoff_recon_closure_receipt_note = ${nextNote},
          stage47_archive_handoff_recon_closure_receipt_user_id = ${receiptState ? sqlUuid(actorUserId) : "p.stage47_archive_handoff_recon_closure_receipt_user_id"},
          stage47_archive_handoff_recon_closure_receipt_at = ${receiptState ? "now()" : "p.stage47_archive_handoff_recon_closure_receipt_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
        p.stage47_archive_handoff_recon_closure_receipt_state as previous_stage47_archive_handoff_recon_closure_receipt_state,
        p.stage47_archive_handoff_recon_closure_receipt_note as previous_stage47_archive_handoff_recon_closure_receipt_note,
        p.stage46_archive_handoff_receipt_reconciliation_closure_state as previous_stage46_archive_handoff_receipt_reconciliation_closure_state,
        p.stage46_archive_handoff_receipt_reconciliation_closure_note as previous_stage46_archive_handoff_receipt_reconciliation_closure_note,
        p.stage45_archive_handoff_receipt_reconciliation_state as previous_stage45_archive_handoff_receipt_reconciliation_state,
        p.stage44_archive_handoff_receipt_state as previous_stage44_archive_handoff_receipt_state,
      ...
      insert into clinical_follow_up_stage47_recon_closure_receipt_events (
        follow_up_id, clinic_id, actor_user_id, event_type, previous_state, next_state,
        archive_handoff_receipt_reconciliation_closure_receipt_state,
        stage46_archive_handoff_receipt_reconciliation_closure_state,
        stage45_archive_handoff_receipt_reconciliation_state, stage44_archive_handoff_receipt_state,
        stage43_archive_receipt_handoff_state, stage42_archive_closure_receipt_state,
        stage41_archive_closure_state, stage40_archive_readiness_state,
        stage39_closure_receipt_state, stage38_reconciliation_closure_state,
        stage37_reconciliation_state, stage36_handoff_receipt_state, note
      )
      select
        u.id, u.clinic_id, ${sqlUuid(actorUserId)},
        'clinical_follow_up.sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt_reconciliation_closure_receipt.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState', coalesce(previous_stage47_archive_handoff_recon_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote', previous_stage47_archive_handoff_recon_closure_receipt_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(previous_stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote', previous_stage46_archive_handoff_receipt_reconciliation_closure_note
        ),
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState', coalesce(u.stage47_archive_handoff_recon_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote', u.stage47_archive_handoff_recon_closure_receipt_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureState', coalesce(u.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNote', u.stage46_archive_handoff_receipt_reconciliation_closure_note
        ),
        coalesce(u.stage47_archive_handoff_recon_closure_receipt_state, 'not_started'),
        coalesce(u.stage46_archive_handoff_receipt_reconciliation_closure_state, 'not_started'),
        coalesce(u.stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
        coalesce(u.stage44_archive_handoff_receipt_state, 'not_started'),
        coalesce(u.stage43_archive_receipt_handoff_state, 'not_started'),
        ...
        coalesce(u.stage37_archive_handoff_receipt_reconciliation_state, 'not_started'),
        coalesce(u.stage36_archive_handoff_receipt_state, 'not_started'),
        ${sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNote || changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState)}
      from updated u
      returning id
    )
    select ${followUpSelect()}
...
export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationSql({
  followUpId,
  actorUserId,
  changes,
  allClinics = false,
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState)
    : "p.stage45_archive_handoff_receipt_reconciliation_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote)
    : "p.stage45_archive_handoff_receipt_reconciliation_note";
  const reconciliationState = ["ready", "reconciled", "reconciliation_exception", "needs_rework"].includes(
    changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState,
  );
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage45_archive_handoff_receipt_reconciliation_state = ${nextState},
          stage45_archive_handoff_receipt_reconciliation_note = ${nextNote},
          stage45_archive_handoff_receipt_reconciled_by_user_id = ${reconciliationState ? sqlUuid(actorUserId) : "p.stage45_archive_handoff_receipt_reconciled_by_user_id"},
          stage45_archive_handoff_receipt_reconciled_at = ${reconciliationState ? "now()" : "p.stage45_archive_handoff_receipt_reconciled_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
        ...
        p.stage45_archive_handoff_receipt_reconciliation_note as previous_stage45_archive_handoff_receipt_reconciliation_note,
        p.stage44_archive_handoff_receipt_state as previous_stage44_archive_handoff_receipt_state,
        p.stage44_archive_handoff_receipt_note as previous_stage44_archive_handoff_receipt_note,
        p.stage43_archive_receipt_handoff_state as previous_stage43_archive_receipt_handoff_state,
        p.stage42_archive_closure_receipt_state as previous_stage42_archive_closure_receipt_state,
        p.stage41_archive_readiness_closure_state as previous_stage41_archive_readiness_closure_state,
        p.stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state as previous_stage40_archive_handoff_receipt_reconciliation_closure_receipt_archive_readiness_state,
      ...
      insert into clinical_follow_up_stage45_handoff_receipt_recon_events (
        follow_up_id, clinic_id, actor_user_id, event_type, previous_state, next_state,
        archive_handoff_receipt_reconciliation_state, stage44_archive_handoff_receipt_state,
        stage43_archive_receipt_handoff_state, stage42_archive_closure_receipt_state,
        stage41_archive_closure_state, stage40_archive_readiness_state,
        stage39_closure_receipt_state, stage38_reconciliation_closure_state,
        stage37_reconciliation_state, stage36_handoff_receipt_state,
        stage35_receipt_handoff_state, stage34_archive_closure_receipt_state, note
      )
      select
        u.id, u.clinic_id, ${sqlUuid(actorUserId)},
        'sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt_reconciliation.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState', coalesce(previous_stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote', previous_stage45_archive_handoff_receipt_reconciliation_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState', coalesce(previous_stage44_archive_handoff_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote', previous_stage44_archive_handoff_receipt_note
        ),
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationState', coalesce(u.stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNote', u.stage45_archive_handoff_receipt_reconciliation_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState', coalesce(u.stage44_archive_handoff_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote', u.stage44_archive_handoff_receipt_note
        ),
        coalesce(u.stage45_archive_handoff_receipt_reconciliation_state, 'not_started'),
        coalesce(u.stage44_archive_handoff_receipt_state, 'not_started'),
        coalesce(u.stage43_archive_receipt_handoff_state, 'not_started'),
...
export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptSql({
  followUpId,
  actorUserId,
  changes,
  allClinics = false,
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState)
    : "p.stage44_archive_handoff_receipt_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote)
    : "p.stage44_archive_handoff_receipt_note";
  const receiptState = ["ready", "received", "receipt_exception", "needs_rework"].includes(
    changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState,
  );
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage44_archive_handoff_receipt_state = ${nextState},
          stage44_archive_handoff_receipt_note = ${nextNote},
          stage44_archive_handoff_received_by_user_id = ${receiptState ? sqlUuid(actorUserId) : "p.stage44_archive_handoff_received_by_user_id"},
          stage44_archive_handoff_received_at = ${receiptState ? "now()" : "p.stage44_archive_handoff_received_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
      ...
      insert into clinical_follow_up_stage44_archive_handoff_receipt_events (
        follow_up_id,
        clinic_id,
        actor_user_id,
        event_type,
      ...
      select
        ...
        u.clinic_id,
        ${sqlUuid(actorUserId)},
        'sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptState', coalesce(previous_stage44_archive_handoff_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNote', previous_stage44_archive_handoff_receipt_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState', coalesce(previous_stage42_archive_closure_receipt_state, 'not_started'),
...
export function buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptSql({
  ...
  const nextState = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState !== undefined
    ? sqlLiteral(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState)
    : "p.stage42_archive_closure_receipt_state";
  const nextNote = changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote !== undefined
    ? sqlNullableText(changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote)
    : "p.stage42_archive_closure_receipt_note";
  const receiptState = ["ready", "received", "receipt_exception", "needs_rework"].includes(
    changes.sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState,
  );
  ...
  return `
    with previous as (
      ...
      update clinical_follow_up_tasks f
      set
          stage42_archive_closure_receipt_state = ${nextState},
          stage42_archive_closure_receipt_note = ${nextNote},
          stage42_archive_closure_receipt_received_by_user_id = ${receiptState ? sqlUuid(actorUserId) : "p.stage42_archive_closure_receipt_received_by_user_id"},
          stage42_archive_closure_receipt_received_at = ${receiptState ? "now()" : "p.stage42_archive_closure_receipt_received_at"},
          updated_at = now()
      from previous p
      where f.id = p.id
      returning f.*,
      ...
      insert into clinical_follow_up_stage42_archive_closure_receipt_events (
        follow_up_id,
        clinic_id,
        actor_user_id,
        event_type,
      ...
      select
        ...
        u.clinic_id,
        ${sqlUuid(actorUserId)},
        'sop_policy_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt.update',
        jsonb_build_object(
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptState', coalesce(previous_stage42_archive_closure_receipt_state, 'not_started'),
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNote', previous_stage42_archive_closure_receipt_note,
          'sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureState', coalesce(previous_stage41_archive_readiness_closure_state, 'not_started'),
...
export function createClinicalFollowUpRepository(dbClient) {
  return {
    ...
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? row.total_follow_ups ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReady ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_ready ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosure: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosure ?? row.needs_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures ?? row.closed_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closures ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureExceptions ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_exceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureNeedsRework ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_needs_rework ?? 0),
        archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.archived_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliations: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliations ?? row.closed_archive_closure_receipt_handoff_receipt_reconciliations ?? 0),
        reconciledArchiveClosureReceiptHandoffReceipts: Number(row.reconciledArchiveClosureReceiptHandoffReceipts ?? row.reconciled_archive_closure_receipt_handoff_receipts ?? 0),
        ...
        handedOffArchiveClosureReceipts: Number(row.handedOffArchiveClosureReceipts ?? row.handed_off_archive_closure_receipts ?? 0),
        receivedArchiveClosureReceipts: Number(row.receivedArchiveClosureReceipts ?? row.received_archive_closure_receipts ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureEvents ?? row.local_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_events ?? 0),
        source: "postgres",
      };
    },
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? row.total_follow_ups ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptReady ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_ready ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipt: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipt ?? row.needs_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipts ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptExceptions ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_exceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptNeedsRework ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_needs_rework ?? 0),
        archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.archived_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliations: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliations ?? row.closed_archive_closure_receipt_handoff_receipt_reconciliations ?? 0),
        reconciledArchiveClosureReceiptHandoffReceipts: Number(row.reconciledArchiveClosureReceiptHandoffReceipts ?? row.reconciled_archive_closure_receipt_handoff_receipts ?? 0),
        ...
        handedOffArchiveClosureReceipts: Number(row.handedOffArchiveClosureReceipts ?? row.handed_off_archive_closure_receipts ?? 0),
        receivedArchiveClosureReceipts: Number(row.receivedArchiveClosureReceipts ?? row.received_archive_closure_receipts ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptEvents ?? row.local_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_events ?? 0),
        source: "postgres",
      };
    },
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? row.total_follow_ups ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReady ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_ready ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoff: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoff ?? row.needs_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff ?? 0),
        handedOffArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffs: Number(row.handedOffArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffs ?? row.handed_off_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoffs ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffExceptions ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_exceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffNeedsRework ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_needs_rework ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipts ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures ?? row.closed_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closures ?? 0),
        archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.archived_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        ...
        receivedArchiveClosureReceiptHandoffReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceipts ?? row.received_archive_closure_receipt_handoff_receipts ?? 0),
        handedOffArchiveClosureReceipts: Number(row.handedOffArchiveClosureReceipts ?? row.handed_off_archive_closure_receipts ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffEvents ?? row.local_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_events ?? 0),
        source: "postgres",
      };
    },
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptReady ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipt: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipt ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptExceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptNeedsRework ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosures: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosures ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptEvents ?? 0),
        source: "postgres",
      };
    },
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? row.total_follow_ups ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReady ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosure: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosure ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosures: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosures ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureExceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureNeedsRework ?? 0),
        reconciledArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts: Number(row.reconciledArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureEvents ?? 0),
        source: "postgres",
      };
    },
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? row.total_follow_ups ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationReady ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliation: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliation ?? 0),
        reconciledArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts: Number(row.reconciledArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationExceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationNeedsRework ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationEvents ?? 0),
        source: "postgres",
      };
    },
    async getClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptSummary(params) {
      const rows = await dbClient.queryJson(buildClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptSummarySql(params));
      const row = rows[0] || {};
      return {
        totalFollowUps: Number(row.totalFollowUps ?? row.total_follow_ups ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReady: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReady ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_ready ?? 0),
        needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipt: Number(row.needsArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipt ?? row.needs_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipts ?? row.handed_off_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoffs ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptExceptions: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptExceptions ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt_exceptions ?? 0),
        archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNeedsRework: Number(row.archiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptNeedsRework ?? row.archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt_needs_rework ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipts ?? 0),
        closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures: Number(row.closedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosures ?? row.closed_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closures ?? 0),
        archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.archivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.archived_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceiptReconciliationClosureReceipts ?? row.received_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipts ?? 0),
        ...
        receivedArchiveClosureReceiptHandoffReceipts: Number(row.receivedArchiveClosureReceiptHandoffReceipts ?? row.received_archive_closure_receipt_handoff_receipts ?? 0),
        handedOffArchiveClosureReceipts: Number(row.handedOffArchiveClosureReceipts ?? row.handed_off_archive_closure_receipts ?? 0),
        localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptEvents: Number(row.localGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptEvents ?? row.local_governance_evidence_reconciliation_closure_receipt_archive_closure_receipt_handoff_receipt_reconciliation_closure_receipt_archive_readiness_closure_receipt_handoff_receipt_events ?? 0),
        source: "postgres",
      };
    },
    ...
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosure(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceipt(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoff(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceipt(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosure(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliation(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
    async updateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceipt(params) {
      const rows = await dbClient.queryJson(buildUpdateClinicalFollowUpSopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptSql(params));
      return rows[0] ? normalizeClinicalFollowUp(rows[0]) : null;
    },
  };
}
