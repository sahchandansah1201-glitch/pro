...
function updateSteps(options) {
  return [
    ...
    ["Verify admin clinic create/edit and audit isolation database journey", "node", [
    ...
    ["Verify admin governance database journey", "node", [
    ...
    ["Verify operator dialog database journey", "node", [
