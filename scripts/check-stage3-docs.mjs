...
const RELEASE_STATUS_SMOKE_TEST = "scripts/release-status-smoke.test.mjs";
...
const RELEASE_STATUS_WORKFLOW_GATE_TEST = "scripts/check-release-status-workflow-gate.test.mjs";
...
requireText(relPath("stage-3c-production-smoke.md"), stage3c, "npm run e2e:release-status");
...
requireText(PACKAGE_JSON, packageJson, "\"test:release-status-ci\": \"node --test scripts/ci-release-status-sync-gate.test.mjs scripts/check-release-status-workflow-gate.test.mjs\"");
...
const releaseStatusSmokeTest = existsSync(join(ROOT, RELEASE_STATUS_SMOKE_TEST))
  ? readFileSync(join(ROOT, RELEASE_STATUS_SMOKE_TEST), "utf8")
  : "";
requireText(RELEASE_STATUS_SMOKE_TEST, releaseStatusSmokeTest, "release-status smoke writes markdown/json/html/history");
requireText(RELEASE_STATUS_SMOKE_TEST, releaseStatusSmokeTest, "check-release-status-privacy.mjs");
requireText(RELEASE_STATUS_SMOKE_TEST, releaseStatusSmokeTest, "Release operations dashboard");
requireText(RELEASE_STATUS_SMOKE_TEST, releaseStatusSmokeTest, "access_token=secret");
requireText(RELEASE_STATUS_SMOKE_TEST, releaseStatusSmokeTest, "SUPABASE_SERVICE_ROLE_KEY");
...
requireText(RELEASE_STATUS_CI_SYNC_SCRIPT, releaseStatusCiSyncScript, "GITHUB_ACTIONS");
requireText(RELEASE_STATUS_CI_SYNC_SCRIPT, releaseStatusCiSyncScript, "Release status gate passed");
requireText(RELEASE_STATUS_CI_SYNC_SCRIPT, releaseStatusCiSyncScript, "Release status gate failed");
requireText(RELEASE_STATUS_CI_SYNC_SCRIPT, releaseStatusCiSyncScript, "Release status reports may be written");

const releaseStatusCiSyncTest = existsSync(join(ROOT, RELEASE_STATUS_CI_SYNC_TEST))
...
const releaseStatusWorkflowGateTest = existsSync(join(ROOT, RELEASE_STATUS_WORKFLOW_GATE_TEST))
  ? readFileSync(join(ROOT, RELEASE_STATUS_WORKFLOW_GATE_TEST), "utf8")
  : "";
requireText(RELEASE_STATUS_WORKFLOW_GATE_TEST, releaseStatusWorkflowGateTest, "workflow gate checker passes and reports all gate checks");
requireText(RELEASE_STATUS_WORKFLOW_GATE_TEST, releaseStatusWorkflowGateTest, "workflow success condition");
requireText(RELEASE_STATUS_WORKFLOW_GATE_TEST, releaseStatusWorkflowGateTest, "CI gate must run before report writes");
...
requireText(RELEASE_STATUS_WORKFLOW, releaseStatusWorkflow, "scripts/release-status-smoke.test.mjs");
requireText(RELEASE_STATUS_WORKFLOW, releaseStatusWorkflow, "scripts/ci-release-status-sync-gate.test.mjs");
requireText(RELEASE_STATUS_WORKFLOW, releaseStatusWorkflow, "scripts/check-release-status-workflow-gate.test.mjs");
...
requireText(relPath("stage-3m-release-operations-dashboard.md"), stage3m, "npm run test:release-status-smoke");
requireText(relPath("stage-3m-release-operations-dashboard.md"), stage3m, "npm run test:release-status-ci");
requireText(relPath("stage-3m-release-operations-dashboard.md"), stage3m, "npm run e2e:release-status");
...
requireText(relPath("stage-3m-release-operations-dashboard.md"), stage3m, "Release status gate failed");
...
const stage3i = readDoc("stage-3i-final-documentation-index.md");
...
const releaseStatusUiPage = existsSync(join(ROOT, RELEASE_STATUS_UI_PAGE))
  ...
  : "";
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Предпросмотр готовности публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Готовность публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Статус проверок");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Проверки публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Уведомление о готовности публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Открыть опубликованный отчёт готовности публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сравнение публикаций");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Импорт журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Вставить журнал истории публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Выбрать эталон готовности публикации");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Статус проверки данных импорта журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Проверить импорт");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фильтр статуса истории");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фильтр служебных файлов истории");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фильтр отчёта истории");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фильтр результата проверок истории");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Поиск по журналу публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сводка фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сбросить фильтры журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сводка ошибок импорта журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать отфильтрованный журнал публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать отфильтрованный журнал публикации таблицей");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать отфильтрованный журнал публикации книгой");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Набор фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сводка наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сохранить текущие фильтры журнала публикации как набор фильтров");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Предпросмотр импорта наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "План импорта наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Подсказки исправления импорта наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фокус на наборах фильтров с ошибкой");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Очистить сохранённые наборы фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Восстановить очищенные наборы фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Аудит наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скачать аудит наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Удалить сохранённый набор фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Подсказки исправления журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фокус на журнале с ошибкой");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Пагинация журнала публикации");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Ошибки формата журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Удалить импортированные эталоны");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скачать служебный отчёт аудита импортов журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скачать табличный отчёт аудита импортов журнала публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фильтр статуса аудита импортов");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фильтр проверки данных аудита импортов");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Предпросмотр выбранного эталона");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать единый пакет готовности публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать готовность публикации");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сверка синхронизации публикации");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скопировать полный блок сверки");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Статус готовности публикации");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Готовность публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка проверок");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Уведомление о готовности публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "clinic_admin");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Импортировать журнал");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Аудит импортов журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Проверить импорт");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фильтр статуса истории");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фильтр служебных файлов истории");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фильтр отчёта истории");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фильтр результата проверок истории");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка ошибок импорта журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать отфильтрованный журнал публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать отфильтрованный журнал публикации таблицей");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать отфильтрованный журнал публикации книгой");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Набор фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Предпросмотр импорта наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "План импорта наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фокус на наборах фильтров с ошибкой");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Очистить сохранённые наборы фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скачать аудит наборов фильтров журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "release-history-filter-presets-audit");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скопировать полный блок сверки");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фокус на журнале с ошибкой");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "release-history-filtered");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Пагинация журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Следующая страница истории");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Ошибки формата журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Удалить импортированные эталоны");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скачать служебный отчёт аудита импортов журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скачать табличный отчёт аудита импортов журнала публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка фильтров аудита импортов");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Предпросмотр выбранного эталона");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "\"summary\"");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать единый пакет готовности публикации");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать готовность публикации: Веб-страница");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "write-gate drill blocks report writes in failed scenario");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Отчёты не записываются");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Найден лишний служебный файл");
...
requireText(APP_SIDEBAR, appSidebar, "Готовность публикации");
