...
const releaseStatusUiPage = existsSync(join(ROOT, RELEASE_STATUS_UI_PAGE))
  ...
  : "";
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Предпросмотр готовности релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Готовность релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Статус проверок");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Проверки релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Уведомление о готовности релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Открыть опубликованный отчёт готовности релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сравнение релизов");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Импорт журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Вставить журнал истории релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Выбрать эталон готовности релиза");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Статус проверки данных импорта журнала релиза");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Поиск по журналу релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сводка фильтров журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сбросить фильтры журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сводка ошибок импорта журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать отфильтрованный журнал релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать отфильтрованный журнал релиза таблицей");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать отфильтрованный журнал релиза книгой");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Пресет фильтров журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сводка пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сохранить текущие фильтры журнала релиза как пресет");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Предпросмотр импорта пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "План импорта пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Подсказки исправления импорта пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фокус на пресетах с ошибкой");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Очистить сохранённые пресеты журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Восстановить очищенные пресеты журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Аудит пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скачать аудит пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Удалить сохранённый пресет журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Подсказки исправления журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Фокус на журнале с ошибкой");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Пагинация журнала релиза");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Ошибки формата журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Удалить импортированные эталоны");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скачать служебный отчёт аудита импортов журнала релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скачать табличный отчёт аудита импортов журнала релиза");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать единый пакет готовности релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Экспортировать готовность релиза");
...
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Сверка синхронизации релиза");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Скопировать полный блок сверки");
requireText(RELEASE_STATUS_UI_PAGE, releaseStatusUiPage, "Статус готовности релиза");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Готовность релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка проверок");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Уведомление о готовности релиза");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Аудит импортов журнала релиза");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка фильтров журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Сводка ошибок импорта журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать отфильтрованный журнал релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать отфильтрованный журнал релиза таблицей");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать отфильтрованный журнал релиза книгой");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Пресет фильтров журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Предпросмотр импорта пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "План импорта пресетов журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Фокус на пресетах с ошибкой");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Очистить сохранённые пресеты журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скачать аудит пресетов журнала релиза");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Пагинация журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Следующая страница истории");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Ошибки формата журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Удалить импортированные эталоны");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скачать служебный отчёт аудита импортов журнала релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Скачать табличный отчёт аудита импортов журнала релиза");
...
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать единый пакет готовности релиза");
requireText(RELEASE_STATUS_UI_E2E, releaseStatusUiE2e, "Экспортировать готовность релиза: Веб-страница");
...
requireText(APP_SIDEBAR, appSidebar, "Готовность релиза");
