...
const REQUIRED_TEXT = {
  ...
  "src/pages/doctor/VisitWorkspaceLiveActions.tsx": ["Получить закрытие передачи", "Доработать получение закрытия", "Квитанции закрытия передачи получены", "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptSummary"],
  "src/pages/doctor/VisitWorkspaceLiveActions.test.tsx": ["Получить закрытие передачи", "sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveClosureReceiptHandoffReceiptReconciliationClosureReceiptArchiveReadinessClosureReceiptHandoffReceiptReconciliationClosureReceiptState"],
