...
stage_evidence:
  ...
  workflows_present:
    ...
    - ".github/workflows/stage6o-production-release-archive-retention-register.yml"
hypotheses:
    - "Next logical stage after Stage 6O is Stage 6P."
sources:
  commands:
    - "git status -sb"
  files:
...
test("project memory guard requires Stage 6P uncertainty to be marked as hypothesis", () => {
  const root = makeRoot();
