...
stage_evidence:
  ...
  workflows_present:
    ...
    - ".github/workflows/stage6i-production-release-archive-index.yml"
hypotheses:
    - "Next logical stage after Stage 6I is Stage 6J."
sources:
  commands:
    - "git status -sb"
  files:
...
test("project memory guard requires Stage 6J uncertainty to be marked as hypothesis", () => {
  const root = makeRoot();
