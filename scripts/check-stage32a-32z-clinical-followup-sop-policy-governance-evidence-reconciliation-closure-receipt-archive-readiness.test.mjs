...
function fixture() {
  ...
  write(root, "src/pages/doctor/VisitWorkspaceLiveActions.tsx", "Архив готов Доработать архив Архивировано sopPolicyGovernanceEvidenceReconciliationClosureReceiptArchiveReadinessSummary");
