...
const REQUIRED_FILES = [
  ...
  "scripts/stage4l-backup-consistency.mjs",
  "scripts/stage4l-q2-disposable.mjs",
  "scripts/stage4l-self-hosted-ops.test.mjs",
  "scripts/stage4l-q2-disposable.test.mjs",
...
const REQUIRED_TEXT = {
  ...
  "scripts/stage4l-self-hosted-ops.mjs": [
    ...
    "SHA256SUMS",
    "Verify backend-owned object storage volume exists",
    "Verify MinIO object storage volume exists",
    "--list",
    "verify-restored-app",
    "verifyEnvText",
    "VITE_APP_MODE",
    ...
    "application_consistent_quiesced",
    "CAPTURE_VALIDATED",
    "stage4l-backup-completion.json",
    "quiescence lifecycle adapter is required",
    "SEALED_RESTORE_POINT",
  ...
  "docs/backend/stage-4l-self-hosted-ops-hardening.md": [
    ...
    "rejected write fully inside",
    "read-only verification of the restored application",
  ],
  ".github/workflows/stage4l-self-hosted-ops-hardening.yml": [
