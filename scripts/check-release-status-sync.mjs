...
const REQUIRED_TEXT = {
  ...
  "src/pages/sys/SysReleaseStatusPage.tsx": [
    "Набор фильтров журнала публикации",
    "Сводка наборов фильтров журнала публикации",
    "Управление наборами фильтров журнала публикации",
    "Сохранить текущие фильтры журнала публикации как набор фильтров",
    "Переименовать сохранённый набор фильтров журнала публикации",
    "Дублировать выбранный набор фильтров журнала публикации",
    "Экспортировать наборы фильтров журнала публикации в служебный файл",
    "Экспортировать наборы фильтров журнала публикации в книгу",
    "Импортировать наборы фильтров журнала публикации",
    "Предпросмотр импорта наборов фильтров журнала публикации",
    "План импорта наборов фильтров журнала публикации",
    "Подсказки исправления импорта наборов фильтров журнала публикации",
    "Фокус на наборах фильтров с ошибкой",
    "Очистить сохранённые наборы фильтров журнала публикации",
    "Восстановить очищенные наборы фильтров журнала публикации",
    "Аудит наборов фильтров журнала публикации",
    "Скачать аудит наборов фильтров журнала публикации",
    "Удалить сохранённый набор фильтров журнала публикации",
    "Экспортировать отфильтрованный журнал публикации книгой",
    "Подсказки исправления журнала публикации",
    "Фокус на журнале с ошибкой",
    "npm run check:release-status-sync",
    "Сверка синхронизации публикации",
    "Скопировать полный блок сверки",
    "npm run ci:release-status-sync",
    "Готовность публикации",
    "Статус проверок",
    "Уведомление о блокере публикации",
    "Открыть опубликованный отчёт готовности публикации",
    "Статус сверки записи отчётов",
    "Проверка записи отчётов публикации",
    "Проверка записи отчётов",
    "Статус проверки записи отчётов",
    "Сценарий проверки записи отчётов",
  ],
  "src/pages/sys/SysReleaseStatusPage.test.tsx": [
  ...
  "e2e/sys-release-status.pw.ts": [
    ...
    "Статус проверки записи отчётов",
    "Проверка записи отчётов публикации",
    "Проверки записи отчётов",
    "Отчёты не записываются",
