...
const REQUIRED_FILES = [
  ...
  "backend/self-hosted/db/migrations/0056_patient_photo_protocol_access_artifact_rotations.sql",
  "backend/self-hosted/db/migrations/0057_patient_photo_protocol_access_credentials.sql",
...
const REQUIRED_TEXT = {
  ...
  "backend/self-hosted/db/migrations/0056_patient_photo_protocol_access_artifact_rotations.sql": [
    "patient_photo_protocol_access_artifact_rotations",
    "metadata-only rotation preparation",
    "prepare_access_artifact_rotation",
    "Raw credentials",
    "signed links remain outside",
  ],
  "backend/self-hosted/db/migrations/0057_patient_photo_protocol_access_credentials.sql": [
    "patient_photo_protocol_access_credentials",
    "credential hashes and fingerprints",
    "Raw credential",
    "credential_hash",
  ...
  "backend/self-hosted/patient-photo-protocol-release-repository.mjs": [
    ...
    "accessArtifactRotationPrepared",
    "requiresSecureCredentialStore",
    "session_lifecycle_review_required",
    "unsafeArtifacts",
    "rotationPending",
    "credentialHashPending",
    "credentialHashReady",
  ...
  "backend/self-hosted/patient-photo-protocol-release-service.mjs": [
    ...
    "unsafeSessionArtifacts",
    "accessArtifactRotationPending",
    "accessArtifactRotationPrepared",
    "credentialHashPending",
    "credentialHashReady",
  ...
  "backend/self-hosted/openapi.stage8g-8i.json": [
    ...
    "credentialHashExposed",
    "credentialFingerprintExposed",
    "qrTokensExposed",
    "sessionIdsExposed",
    "patientPhotoProtocol",
  ...
  "backend/self-hosted/routes.mjs": [
    ...
    "governance/revoke-expired",
    "governance/block-missing-expiry",
    "governance/block-unapproved-retention",
    "governance/block-unsafe-session-artifacts",
    "governance/prepare-access-artifact-rotation",
    "governance/issue-access-credential-hash",
    "stage: \"8G-8I\"",
    "openapiStage8G8I",
  ],
  "src/lib/self-hosted-clinical-report-package-api.ts": [
  ...
  "src/pages/admin/AdminGovernancePage.tsx": [
    ...
    "Заблокировать без срока",
    "Заблокировать без политики",
    "Заблокировать артефакты доступа",
    "Подготовить ротацию доступа",
    "Создать хэш доступа",
    "Ротация нужна",
    "Хэш нужен",
    "Хэш готов",
    "Последняя backend-операция",
