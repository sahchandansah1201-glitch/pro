...
const REQUIRED_TEXT = {
  ...
  "backend/self-hosted/patient-photo-protocol-delivery-repository.mjs": [
    ...
    "patient_photo_protocol_releases",
    "patient_photo_protocol_access_sessions",
    "session_kind = 'patient_photo_protocol_access'",
    "session_hash",
    "sessionBoundaryMatched",
  ...
  "backend/self-hosted/patient-photo-protocol-delivery-service.mjs": [
    ...
    "photo_protocol_session_required",
    "photo_protocol_session_invalid",
    "photo_protocol_session_not_configured",
  ...
  "backend/self-hosted/routes.mjs": [
    ...
    "patientPortalPhotoProtocolAccessSessionEndMatch",
  ...
  "backend/self-hosted/openapi.stage5n.json": [
    ...
    "/api/v1/me/photo-protocols/{visitId}/access/session/end",
    "/api/v1/me/photo-protocols/{visitId}/photos/{sequence}/download",
    "Set-Cookie",
    "HttpOnly Secure SameSite=Strict",
    "The HttpOnly photo-protocol session cookie is missing, invalid, or expired",
    "retention policy is approved",
    "PatientPortalPhotoProtocol",
    "PatientPortalPhotoProtocolAccessExchange",
    "PatientPortalPhotoProtocolAccessSessionEnd",
  ...
  "src/lib/self-hosted-patient-portal-api.ts": [
    ...
    "Подтвердите доступ к фото-протоколу.",
    "Сессия доступа к фото-протоколу истекла или не подтверждена.",
    "/api/v1/me/portal",
    "/api/v1/me/history",
    "/api/v1/me/reports/",
    "/api/v1/me/photo-protocols/",
