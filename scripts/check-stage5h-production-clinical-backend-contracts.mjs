...
const REQUIRED_TEXT = {
  ...
  "backend/self-hosted/db/migrations/0082_stage5h_production_dataset_evidence.sql": [
    ...
    "visit_longitudinal_timeline_rollout_production_dataset_metadata_no_protected_keys",
  ...
  "backend/self-hosted/db/migrations/0084_stage5h_production_reviewer_evidence.sql": [
    "Batch CH",
    "visit_longitudinal_timeline_rollout_production_reviewer_evidence_reviews",
    ...
    "visit_longitudinal_timeline_rollout_production_reviewer_evidence_metadata_no_protected_keys",
  ...
  "backend/self-hosted/clinical-workspace-repository.mjs": [
    ...
    "ready_for_production_dataset_evidence",
    "ready_for_production_reviewer_governance",
    "productionReviewerGovernanceBoundary",
    "productionReviewerEvidenceBoundary",
    "productionReviewerOpsBoundary",
    "lesion_comparison_decision_drafts",
    "clinical_asset_capture_metadata",
    "device_evidence_status",
  ...
  "backend/self-hosted/clinical-workspace-service.mjs": [
    ...
    "reviewVisitLongitudinalTimelineRolloutProtectedReviewerEvidence",
    "reviewVisitLongitudinalTimelineRolloutProductionDatasetEvidence",
    "reviewVisitLongitudinalTimelineRolloutProductionReviewerGovernance",
    "reviewVisitLongitudinalTimelineRolloutProductionReviewerEvidence",
    "getVisitLesionComparisonViewerQaReviewQueue",
    "getVisitLongitudinalDatasetValidation",
    "getLesionLongitudinalHistory",
    "getLesionLongitudinalQa",
  ...
  "backend/self-hosted/routes.mjs": [
    ...
    "visitLongitudinalTimelineRolloutProtectedReviewerValidationMatch",
    "visitLongitudinalTimelineRolloutProtectedReviewerGovernanceMatch",
    "visitLongitudinalTimelineRolloutProtectedReviewerEvidenceMatch",
    "visitLongitudinalTimelineRolloutProductionDatasetEvidenceMatch",
    "visitLongitudinalTimelineRolloutProductionReviewerGovernanceMatch",
    "visitLongitudinalTimelineRolloutProductionReviewerEvidenceMatch",
  ...
  "backend/self-hosted/openapi.stage5h.json": [
    ...
    "/api/v1/visits/{visitId}/longitudinal-timeline-rollout/protected-reviewer-evidence",
    "/api/v1/visits/{visitId}/longitudinal-timeline-rollout/production-dataset-evidence",
    "/api/v1/visits/{visitId}/longitudinal-timeline-rollout/production-reviewer-governance",
    "/api/v1/visits/{visitId}/longitudinal-timeline-rollout/production-reviewer-evidence",
    ...
    "VisitLongitudinalTimelineRolloutProductionDatasetEvidencePayload",
    "VisitLongitudinalTimelineRolloutProductionReviewerGovernance",
    "VisitLongitudinalTimelineRolloutProductionReviewerEvidence",
    "VisitLongitudinalTimelineRolloutProductionReviewerGovernancePayload",
  ...
  "src/pages/doctor/VisitWorkspacePage.tsx": [
    ...
    "Production dataset evidence metadata сохранён",
    ...
    "Production reviewer governance metadata сохранён",
    "Проверить production assets",
    "assets:",
