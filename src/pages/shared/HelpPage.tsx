...
const ROLES: RoleRef[] = [
  {
    ...
    forbidden: [
      "Передавать сводку помощника как врачебное решение.",
      "Отправлять снимки во внешние мессенджеры или учётные системы.",
      "Вводить данные пациента без согласия и прав доступа.",
    ],
  },
  {
  ...
  },
  {
    ...
    responsibilities:
      "Наблюдение за обращениями, помощь с записью, передача в клинику. Без медицинских решений.",
    routes: ["/operator"],
    safe: [
      "Помогать с записью и навигацией по помощнику записи.",
      "Передавать сложные обращения в клинику.",
  ...
  },
  {
    ...
    forbidden: [
      ...
      "Хранить ключи и секреты в интерфейсе программы.",
  ...
  },
  {
    ...
    safe: [
      "Смотреть заключения, подготовленные для пациента.",
    ...
    forbidden: [
      ...
      "Получать врачебное решение от помощника записи.",
...
const BOT: RouteRef[] = [
  { path: "/bot-sim", description: "Помощник записи: путь от фото к заявке." },
...
const DATA_POLICY = [
  ...
  "Во внешнюю учётную систему не уходит врачебный вывод: только статус заявки и факт записи.",
            ...
            <div className="flex-1">
              ...
              {bannerOpen && (
                <ul id="safety-banner-body" className="mt-1 space-y-1">
                  <li>Права на разделы проверяются сервером и зависят от роли сотрудника.</li>
                  <li>Пациентские данные, снимки и служебные значения не выводятся в справке.</li>
                  <li>Помощник записи даёт только навигационную подсказку для передачи врачу.</li>
        ...
        {!isSearching && (
          <Section id="policy" icon={Lock} title="Правила данных">
            ...
            <p className="mt-3 text-[11px] italic text-muted-foreground">
              Справка показывает назначение разделов и ограничения ролей. Пациентские данные, снимки, ключи доступа и служебные значения здесь не выводятся.
            </p>
          </Section>
        )}
      </div>
