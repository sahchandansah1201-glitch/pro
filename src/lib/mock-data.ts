...
export const ASSESSMENTS: Assessment[] = [
  ...
  },
  {
    ...
    aiSupport: aiNeutral("medium", 0.62, ["неровная граница", "две зоны цвета"], ["возможны артефакты сжатия"], "Подсветка зон неровной границы."),
  ...
  },
  {
    ...
    sevenPoint: { major: 1, minor: 1, total: 4 },
    aiSupport: aiNeutral("medium", 0.65, ["лёгкая асимметрия", "две зоны цвета"], ["небольшое размытие"], "Слабая активность XAI на границе."),
  ...
  },
  {
    ...
    sevenPoint: { major: 0, minor: 1, total: 1 },
    aiSupport: aiNeutral("uncertain", 0.51, ["неоднородная текстура"], ["низкое качество фото", "блики"], "XAI-карта неоднозначна, требуется повтор фото."),
