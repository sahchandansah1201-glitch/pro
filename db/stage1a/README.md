...
>
> **Created artifacts only — local verification required.** No SQL has been
> executed in the agent sandbox.
...
Expected: `stage1a_rls.test.sql` reports `# All tests passed` with 34 assertions.
...
- `npx supabase test db` reports 34/34 assertions passed.
